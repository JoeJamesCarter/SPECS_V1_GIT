<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FurnitureHardwareSouth.aspx.vb" Inherits="FurnitureHardwareSouth" %>
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Veada">
                        <ItemTemplate>
                            ...
                            <asp:GridView ID="gvOrderLines" runat="server" AutoGenerateColumns="False" BorderStyle="None" Width="100%" ShowHeader="False" OnRowCommand="gvOrderLines_RowCommand" OnRowDataBound="gvOrderLines_RowDataBound">
                                <Columns>
