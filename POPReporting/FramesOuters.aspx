<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FramesOuters.aspx.vb" Inherits="FramesOuters" MaintainScrollPositionOnPostback="true" Debug="True"%>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Frames Outers</title>
...
<body>
    ...
    <div>
            ...
            <asp:Table ID="tblHeader" runat="server" CssClass="auto-style1" Width="1024px" GridLines="None">
                <asp:TableRow>
                    <asp:TableCell>
                        <span class="newStyle7">FRAMES OUTERS</span><br />
                ...
                <asp:TemplateField HeaderText="Update">
                    <ItemTemplate>
                        ...
                        <asp:GridView ID="gvFabOptionsCentertubesDirectFill" runat="server" GridLines="None" ShowHeader="False" AutoGenerateColumns="False" DataSourceID="sdsPopReportingFabOptionsDirectFill" Width="100%" CssClass="newStyle3">
                             ...
                             <asp:SqlDataSource ID="sdsPopReportingFabOptionsDirectFill" runat="server" ConnectionString="<%$ ConnectionStrings:bml_dataConnectionString %>" SelectCommand="SELECT [ProdNo], [PopNo], [Option_Item], [Option_Desc] FROM [BML_POPREPORTINGFABOPTIONS] WHERE ([ProdNo] = @ProdNo) AND ([Workcenter] = @Workcenter OR Workcenter = 'Tubes') AND (Option_Desc Like '%DIRECT FILL%' or Option_Desc Like '%REQ 1/2%' or Option_Item = '904610' or Option_Item = '910423' or Option_Item = '910424' or Option_Item = '910426' or Option_Item = '910427' or Option_Item = '910425' or Option_Item = '910429' or Option_Item = '905496' or Option_Desc Like '*ESP 600*') ORDER BY [Option_Desc]">
                                 <SelectParameters>
                                     <asp:Parameter Name="ProdNo" Type="String" />
                        ...
                        <br />
                        <br /><strong><asp:Label ID="isTopDeck" class="newStyle3" runat="server" Width="100%" Text=""></asp:Label></strong>
                         </ItemTemplate>
