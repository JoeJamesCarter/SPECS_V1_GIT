...
Partial Class Kitting4TV
    ...
    Protected Sub Timer1_Tick(ByVal sender As Object, ByVal e As EventArgs)
        ...
        cmd2.CommandText = "Select Count (*) FROM BML_POPREPORTING_GREENLIGHTS where BuildLoc = 'M' and Kitting4Status = 2 and Convert(date,Kitting4) ='" & ThisDay & "'"
        cmd3.CommandText = "Select Count (*) FROM BML_POPREPORTING_GREENLIGHTS where BuildLoc = 'S' and Kitting4Status = 2 and Convert(date,Kitting4) ='" & ThisDay & "'"
        cmd4.CommandText = "Select Count (*) FROM BML_POPREPORTING_GREENLIGHTS where BuildLoc = 'V' and Kitting4Status = 2 and Convert(date,Kitting4) ='" & ThisDay & "'"
    ...
    Private Sub Repeater1_ItemCommand(source As Object, e As RepeaterCommandEventArgs) Handles Repeater1.ItemCommand, Repeater2.ItemCommand, Repeater3.ItemCommand
        If e.CommandName = "gotoupdate" Then
            ...
            cmd.CommandText = "UPDATE BML_POPREPORTING_GREENLIGHTS SET Kitting4Status = '2', Kitting4 = '" & TodaysDate & "' where ProdNo =  '" & SelectedProdNo & "'"
            cmd2.CommandText = "Select Count (*) FROM BML_POPREPORTING_GREENLIGHTS where BuildLoc = 'M' and Kitting4Status = 2 and Convert(date,Kitting4) ='" & ThisDay & "'"
            cmd3.CommandText = "Select Count (*) FROM BML_POPREPORTING_GREENLIGHTS where BuildLoc = 'S' and Kitting4Status = 2 and Convert(date,Kitting4) ='" & ThisDay & "'"
            cmd4.CommandText = "Select Count (*) FROM BML_POPREPORTING_GREENLIGHTS where BuildLoc = 'V' and Kitting4Status = 2 and Convert(date,Kitting4) ='" & ThisDay & "'"
