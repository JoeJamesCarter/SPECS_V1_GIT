...
<script runat="server">
 ...
 <div>
     <asp:SqlDataSource ID="sdsWeldDate" runat="server" ConnectionString="<%$ ConnectionStrings:bml_dataConnectionString %>" SelectCommand="SELECT Distinct WeldDate FROM [Rails_Tracking] where Convert(date,WeldDate) &gt;= '10/09/2017' Order By WeldDate Desc"></asp:SqlDataSource>
