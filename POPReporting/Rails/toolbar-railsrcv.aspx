...
<script runat="server">
 ...
 <div>
     <asp:SqlDataSource ID="sdsWeldDate" runat="server" ConnectionString="<%$ ConnectionStrings:bml_dataConnectionString %>" SelectCommand="SELECT Distinct WeldDate FROM [Rails_Tracking] where Convert(date,WeldDate) &gt;= '09/01/2017' Order By WeldDate Desc"></asp:SqlDataSource>
    <asp:table id="Table1" runat="server" cssclass="auto-style1" width="966px" gridlines="None">
        <asp:TableRow runat="server">
            <asp:TableCell runat="server" HorizontalAlign="center">
                <span class="newStyle3"><asp:Label ID="lblNumLocsInUse" runat="server" Text=""></asp:Label>&nbsp;Locations In Use&nbsp;&nbsp;</span>                
            </asp:TableCell>
            <asp:TableCell runat="server"><span class="newStyle3">Date&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:DropDownList ID="ddlDateSelected" DataSourceID="sdsWeldDate" runat="server" DataTextFormatString="{0:d}"  DataTextField = "WeldDate" DataValueField = "WeldDate" AutoPostBack="True">
                ...
                <span class="newStyle3">&nbsp;&nbsp;Show Rails&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <asp:button runat="server" text="Clear" id="btnClear" onclick="btnClear_Click" /></span>
        ...
        <asp:TableRow runat="server">
            ...
            <asp:HyperLink runat="server" Target="_blank" NavigateUrl="./RackMap.aspx">Rack Map</asp:HyperLink>
                </asp:TableCell>
            <asp:TableCell>
