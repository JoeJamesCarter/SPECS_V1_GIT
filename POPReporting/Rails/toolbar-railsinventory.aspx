...
<span class="newStyle3"><asp:Label ID="lblNumRails" runat="server" Text=""></asp:Label>&nbsp;<asp:Label runat="server" Text="Rails In Inventory"></asp:Label></span>
                </asp:TableCell>
            <asp:TableCell>
    ...
    <asp:button runat="server" text="Clear" id="btnClear" onclick="btnClear_Click" /></span>
        ...
        <asp:TableRow runat="server">
            ...
            <asp:TableCell>
            <span class="newStyle3">Select Which Rails #&#39;s to Show&nbsp
    ...
    <asp:button id="btbClear2" runat="server" text="Clear" onclick="btbClear2_Click" /></span>
        ...
        <asp:TableRow runat="server">
            ...
            <asp:TableCell>
                ...
                <span class="newStyle3"> <span class="newStyle3">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;PT:&nbsp
                <asp:DropDownList ID="ddlPT" runat="server" AutoPostBack="True">
                <asp:ListItem Value="0">All</asp:ListItem>                
                <asp:ListItem Value="1">PT</asp:ListItem>                
            </asp:DropDownList></span>
