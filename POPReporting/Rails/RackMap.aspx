<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RackMap.aspx.vb" Inherits="Rails_RackMap" Debug="true" %>
<!DOCTYPE html>
                ...
                <ContentTemplate>
                    <div class="float-left">
                        ...
                        <asp:Repeater ID="Repeater1" runat="server" DataSourceID="sdsRacks">
                            ...
                            <asp:SqlDataSource ID="sdsRacks" runat="server" ConnectionString="<%$ ConnectionStrings:bml_dataConnectionString %>" SelectCommand="SELECT RailsSlot, Case When Protech = 1 then 'Y' else 'N' end as Protech, TrimStatus, Rails_KittingLocations.ProdNo,DateIn,InUse, CusName, CusNo, BML_POPREPORTING_GREENLIGHTS.ItemNo, BML_POPREPORTING_GREENLIGHTS.IsPilot, BML_POPREPORTING_GREENLIGHTS.DueDate, RailsStatus, BML_POPREPORTING_GREENLIGHTS.BuildLoc, Blackout, Powertop, FurnitureStatus, FiberglassStatus, CoversStatus, TubesStatus, CentertubeNeeded, CentertubeStatus, GaugeStatus, HarnessStatus, HasAllRails,Requested, ArchTowerNeeded, ArchTowerStatus, ProdLineDesc, BML_POPREPORTING_GREENLIGHTS.ProdLineID FROM [Rails_KittingLocations] left join BML_POPREPORTING_GREENLIGHTS on Rails_KittingLocations.ProdNo = BML_POPREPORTING_GREENLIGHTS.ProdNo left join Rails_Tracking on Rails_KittingLocations.ProdNo = Rails_Tracking.ProdNo Left Join ProductionLines on BML_POPREPORTING_GREENLIGHTS.ProdLineID = ProductionLines.ProdLineID order by RailsSlot"></asp:SqlDataSource>
