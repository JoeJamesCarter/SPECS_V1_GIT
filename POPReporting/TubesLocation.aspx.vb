...
Partial Class TubesLocation
    ...
    Protected Sub gvAllFieldsT_RowCommand(sender As Object, e As GridViewCommandEventArgs) Handles gvAllFieldsT.RowCommand
        ...
        If e.CommandName = "UpdateTLocStatus" Then
            ...
            Dim rbList As RadioButtonList = DirectCast(gvAllFieldsT.Rows(Key).Cells(4).FindControl("rblTubesLocationStatus"), RadioButtonList)
            ...
            cmd.CommandText = "UPDATE BML_POPREPORTING_GREENLIGHTS SET TubesOutside = '" & rbList.SelectedValue & "' where ProdNo =  '" & SelectedProdNo & "'"
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        tstatus.Value = "2" ' only show tubes that are complete on this page.
        fstatus.Value = "2" ' only show boats that haven't started in Frames.
