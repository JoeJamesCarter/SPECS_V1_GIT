<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FurniturePrep.aspx.vb" Inherits="FurniturePrep" MaintainScrollPositionOnPostback="true" %>
                         ...
                         <ItemTemplate>
                            <asp:GridView ID="GridView4" runat="server" AutoGenerateColumns="False" GridLines="None" BorderStyle="None" DataSourceID="sdsVendorInfo" ShowHeader="False">
                                <Columns>
                                    ...
                                    <asp:ImageField DataImageUrlField="F_ReadyToLoad" DataImageUrlFormatString="./Images/incomplete{0}.png">
                                    </asp:ImageField>
                                </Columns>
                            </asp:GridView>
                            <asp:SqlDataSource ID="sdsVendorInfo" runat="server" ConnectionString="<%$ ConnectionStrings:bml_dataConnectionString %>" SelectCommand="SELECT [F_Enroute_Status], [F_Truck], [F_Est_ETA], [F_ReadyToLoad] FROM [Vendor_Info] WHERE ([ProdNo] = @ProdNo)">
                                <SelectParameters>
