 ...
 <div>
    <asp:table id="Table1" runat="server" cssclass="auto-style1" width="1042px" gridlines="None">
        <asp:TableRow runat="server">
            <asp:TableCell runat="server" HorizontalAlign="center">
                <asp:Label ID="lblBoatsStarted" runat="server" CssClass="newStyle4" Text="Label"></asp:Label><span class="newStyle3">&nbsp;Started Today</span>
            </asp:TableCell>
    ...
    <asp:button runat="server" text="Clear" id="btnClear" onclick="btnClear_Click" /></span>
        ...
        <asp:TableRow runat="server">
            ...
            <asp:Label ID="lblSouthShrink" runat="server" CssClass="newStyle4" Text="Label"></asp:Label><span class="newStyle3">&nbsp;South Shrunk</span>
                </asp:TableCell>
            <asp:TableCell>
