<%@ Page Language="VB" AutoEventWireup="false" CodeFile="DecksNoRails.aspx.vb" Inherits="Workstations_DecksNoRails" MaintainScrollPositionOnPostback="true" %>
    ...
    <form id="form1" runat="server">
     <div>
            <asp:Table ID="tblHeader" runat="server" CssClass="auto-style1" Width="1024px" GridLines="None">
                <asp:TableRow>
                    <asp:TableCell>
                        <span class="newStyle7">DECKS - NO RAILS</span><br />
