<%@ Page Language="VB" AutoEventWireup="false" CodeFile="SouthWIP.aspx.vb" Inherits="Workstations_SouthWIP" MaintainScrollPositionOnPostback="true" %>
    ...
    <form id="form1" runat="server">
        <div>
            <asp:Table ID="tblHeader" runat="server" CssClass="auto-style1" Width="1024px" GridLines="None">
                <asp:TableRow>
                    <asp:TableCell>
                        <span class="newStyle7">SOUTH-WIP</span><br />
                    ...
                    <%--<asp:TableCell>
                        <asp:Chart ID="Chart1" runat="server" DataSourceID="sdsWIP" Height="187px" Width="331px" ImageLocation="../Charts/ChartPic_#SEQ(300,3)" ImageStorageMode="UseImageLocation">
            <Series>
        ...
        <asp:TableCell>
             <asp:Chart ID="Chart2" runat="server" DataSourceID="sdsIOTwinOther" Height="187px" Width="331px" ImageLocation="../Charts/ChartPic_#SEQ(300,3)" ImageStorageMode="UseImageLocation">
            <Series>
