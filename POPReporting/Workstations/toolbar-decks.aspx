 ...
 <div>
    <asp:table id="Table1" runat="server" cssclass="auto-style1" width="1042px" gridlines="None">
        <asp:TableRow runat="server">
            <asp:TableCell runat="server" HorizontalAlign="center">
                <asp:Label ID="lblBoatsStarted" runat="server" CssClass="newStyle4" Text="Label"></asp:Label><span class="newStyle3">&nbsp;Are Pilots</span>
            </asp:TableCell>
    ...
    <asp:button runat="server" text="Clear" id="btnClear" onclick="btnClear_Click" /></span>
        ...
        <asp:TableRow runat="server">
            ...
            <asp:Label ID="lblSouthDecks" runat="server" CssClass="newStyle4" Text="Label"></asp:Label><span class="newStyle3">&nbsp;Decks Outside</span>
                </asp:TableCell>
            <asp:TableCell>
            ...
            <asp:DropDownList ID="ddlShowSelect" runat="server" AutoPostBack="True">
                ...
                <asp:ListItem Value="1">Inside Not Yet Railed</asp:ListItem>                
            </asp:DropDownList></span>
            </asp:TableCell>
            <asp:TableCell>
