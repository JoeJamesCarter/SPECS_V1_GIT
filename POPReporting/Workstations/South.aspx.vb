...
Partial Class Workstations_South
    ...
    Protected Sub gvFloors_RowCommand(sender As Object, e As GridViewCommandEventArgs) Handles gvFloors.RowCommand
        ...
        If e.CommandName = "gotoupdate" Then
            ...
            Dim img As Image = CType(gvFloors.Rows(Key).FindControl("btnUpdateSouth"), Image)
            ...
            cmd.CommandText = "UPDATE BML_POPREPORTING_GREENLIGHTS SET Loc = 'S', MoveDate = '" & TodaysDate & "' where ProdNo =  '" & SelectedProdNo & "'"
            cmd2.CommandText = "Select Count (*) FROM BML_POPREPORTING_GREENLIGHTS where Loc = 'S' and Convert(date,MoveDate) ='" & ThisDay & "'"
            ...
            cmd4.CommandText = "UPDATE BML_POPREPORTING_GREENLIGHTS SET Loc = 'M', MoveDate = NULL where ProdNo =  '" & SelectedProdNo & "' and RailsInstalled is NULL"
