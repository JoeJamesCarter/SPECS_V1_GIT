...
Partial Class Workstations_Rails
    ...
    Protected Sub gvRails_RowCommand(sender As Object, e As GridViewCommandEventArgs) Handles gvRails.RowCommand
        ...
        If e.CommandName = "gotoupdate" Then
            ...
            Dim img As Image = CType(gvRails.Rows(Key).FindControl("btnUpdateRails"), Image)
            Dim railsvalue = img.ImageUrl
            railsvalue = Mid(railsvalue, 26, 1) 'get the value of RailsInstalledStatus from the imageurl.
            ...
            cmd.CommandText = "UPDATE BML_POPREPORTING_GREENLIGHTS SET RailsInstalledStatus = '2', FurnitureInstalledStatus = '1', RailsInstalled = '" & TodaysDate & "' where ProdNo =  '" & SelectedProdNo & "'"
            cmd2.CommandText = "Select Count (*) FROM BML_POPREPORTING_GREENLIGHTS where RailsInstalledStatus = 2 and BuildLoc = 'M' and Convert(date,RailsInstalled) ='" & ThisDay & "'"
            ...
            cmd4.CommandText = "UPDATE BML_POPREPORTING_GREENLIGHTS SET RailsInstalledStatus = '1', FurnitureInstalledStatus = '0', RailsInstalled = NULL where ProdNo =  '" & SelectedProdNo & "' and FurnitureInstalled is NULL"
            ...
            cmd6.CommandText = "Select Count (*) FROM BML_POPREPORTING_GREENLIGHTS where RailsInstalledStatus = 2 and BuildLoc = 'S' and Convert(date,RailsInstalled) ='" & ThisDay & "'"
            cmd7.CommandText = "Select Count (*) FROM BML_POPREPORTING_GREENLIGHTS where RailsInstalledStatus = 2 and BuildLoc = 'V' and Convert(date,RailsInstalled) ='" & ThisDay & "'"

            cmd8.CommandText = "Select Count (*) FROM BML_POPREPORTING_GREENLIGHTS where RailsInstalledStatus = 1 and BuildLoc = 'M' and CompleteStatus < 2 and ProdNo > 2110000"
            cmd9.CommandText = "Select Count (*) FROM BML_POPREPORTING_GREENLIGHTS where RailsInstalledStatus = 1 and BuildLoc = 'S' and CompleteStatus < 2 and ProdNo > 2110000"
            cmd10.CommandText = "Select Count (*) FROM BML_POPREPORTING_GREENLIGHTS where RailsInstalledStatus = 1 and BuildLoc = 'V' and CompleteStatus < 2 and ProdNo > 2110000"
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        cmd4.CommandText = "Select Count (*) FROM BML_POPREPORTING_GREENLIGHTS where RailsInstalledStatus = 2 and BuildLoc = 'S' and Convert(date,RailsInstalled) ='" & ThisDay & "'"
        cmd5.CommandText = "Select Count (*) FROM BML_POPREPORTING_GREENLIGHTS where RailsInstalledStatus = 2 and BuildLoc = 'V' and Convert(date,RailsInstalled) ='" & ThisDay & "'"

        cmd6.CommandText = "Select Count (*) FROM BML_POPREPORTING_GREENLIGHTS where RailsInstalledStatus = 1 and BuildLoc = 'M' and CompleteStatus < 2 and ProdNo > 2110000"
        cmd7.CommandText = "Select Count (*) FROM BML_POPREPORTING_GREENLIGHTS where RailsInstalledStatus = 1 and BuildLoc = 'S' and CompleteStatus < 2 and ProdNo > 2110000"
        cmd8.CommandText = "Select Count (*) FROM BML_POPREPORTING_GREENLIGHTS where RailsInstalledStatus = 1 and BuildLoc = 'V' and CompleteStatus < 2 and ProdNo > 2110000"
