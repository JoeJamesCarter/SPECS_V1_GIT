<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RailsSouth.aspx.vb" Inherits="Workstations_RailsSouth" MaintainScrollPositionOnPostback="true" %>
...
<ItemStyle HorizontalAlign="Center"></ItemStyle>
                ...
                <asp:TemplateField HeaderText="Boat/Customer">
                    <ItemTemplate>
                        <asp:Label ID="lblItemNo" runat="server" Text='<%# Eval("ItemNo") %>' CssClass="newStyle6"></asp:Label>
               ...
               <asp:ImageField DataImageUrlField="IsCustom" DataImageUrlFormatString="../Images/Custom{0}.png" HeaderText="Custom">
                ...
                <asp:TemplateField HeaderText="Rails">
                    <ItemTemplate>
                        <asp:ImageButton ID="btnUpdateRails" runat="server"  Enabled =' <%# Eval("RailsInstalledStatus") >= 1%>' ImageUrl='<%# Eval("RailsInstalledStatus", "../Images/complete_status{0}.png")%>' CommandArgument="<%# Container.DataItemIndex %>"  CommandName="gotoupdate"/>                                           
                    </ItemTemplate>
                </asp:TemplateField>
