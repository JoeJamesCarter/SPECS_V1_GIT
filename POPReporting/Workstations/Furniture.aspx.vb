...
Partial Class Workstations_Furniture
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        cmd4.CommandText = "Select Count (*) FROM BML_POPREPORTING_GREENLIGHTS where FurnitureInstalledStatus = 2 and BuildLoc = 'V' and Convert(date,FurnitureInstalled) ='" & ThisDay & "'"
        cmd5.CommandText = "Select Count (*) FROM BML_POPREPORTING_GREENLIGHTS where FurnitureInstalledStatus = 2 and BuildLoc = 'S' and Convert(date,FurnitureInstalled) ='" & ThisDay & "'"

        cmd6.CommandText = "Select Count (*) FROM BML_POPREPORTING_GREENLIGHTS where FurnitureInstalledStatus = 1 and BuildLoc = 'M' and CompleteStatus < 2 and ProdNo > 2110000"
        cmd7.CommandText = "Select Count (*) FROM BML_POPREPORTING_GREENLIGHTS where FurnitureInstalledStatus = 1 and BuildLoc = 'S' and CompleteStatus < 2 and ProdNo > 2110000"
        cmd8.CommandText = "Select Count (*) FROM BML_POPREPORTING_GREENLIGHTS where FurnitureInstalledStatus = 1 and BuildLoc = 'V' and CompleteStatus < 2 and ProdNo > 2110000"
        ...
        lblBoatsStartedS.Text = cmd5.ExecuteScalar
        lblVBoatsStarted.Text = cmd4.ExecuteScalar
