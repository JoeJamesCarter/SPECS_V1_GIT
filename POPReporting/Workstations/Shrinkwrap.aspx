<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Shrinkwrap.aspx.vb" Inherits="Workstations_Shrinkwrap" MaintainScrollPositionOnPostback="true" Debug="true" %>
...
<body>
    <form id="form2" runat="server">
            ...
            <asp:Table ID="tblHeader" runat="server" CssClass="auto-style1" Width="1024px" GridLines="None">
                <asp:TableRow>
                    <asp:TableCell Wrap="false">
                        <span class="newStyle7">SHRINKWRAP</span><br />
        ...
        <asp:GridView ID="gvShrinkwrap" runat="server" AutoGenerateColumns="False" CssClass="newStyle1" DataKeyNames="PopNo" DataSourceID="sdsPopReporting" CellPadding="8" PageSize="20">
            <Columns>
                ...
                <asp:TemplateField HeaderText="Options">
                    <ItemTemplate>
                        <asp:GridView ID="gvShrinkwrapOptions" runat="server" GridLines="None" ShowHeader="False" AutoGenerateColumns="False" DataSourceID="sdsFabOptionsShrinkwrap">
                            <Columns>
                        ...
                        <asp:SqlDataSource ID="sdsFabOptionsShrinkwrap" runat="server" ConnectionString="<%$ ConnectionStrings:bml_dataConnectionString %>" SelectCommand="SELECT [Option_Desc] FROM [BML_POPREPORTINGFABOPTIONS] WHERE (([ProdNo] = @ProdNo) AND ([Workcenter] = @Workcenter))">
                            <SelectParameters>
                                <asp:ControlParameter ControlID="gvShrinkwrap" Name="ProdNo" PropertyName="SelectedValue" Type="String" />
                                <asp:Parameter DefaultValue="Shrinkwrap" Name="Workcenter" Type="String" />
                            </SelectParameters>
                        </asp:SqlDataSource>
                    </ItemTemplate>
                    <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Shrink Wrap">
                    <ItemTemplate>
                        <asp:ImageButton ID="btnUpdateShrinkwrap" runat="server" Enabled=' <%# Eval("ShrinkwrapStatus") >= 1%>' ImageUrl='<%# Eval("ShrinkwrapStatus", "../Images/complete_status{0}.png")%>' CommandArgument='<%# Container.DataItemIndex & ";" & Eval("BuildLoc") & ";" & Eval("WavetamerNeeded") & ";" & Eval("SharkhideNeeded") & ";" & Eval("RiggingNeeded") %>' CommandName="gotoupdatenew" />
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="Notes">
                    <ItemTemplate>
                        ...
                        <asp:ImageButton ID="btnWSNotes" runat="server" Visible='<%#Eval("NotesShrinkwrap") = 1%>' ImageUrl='<%# Eval("NotesShrinkwrap", "../Images/wsnotes{0}.png")%>' CommandArgument="<%# Container.DataItemIndex %>" CommandName="gotonotes" />
                    </ItemTemplate>
                </asp:TemplateField>
