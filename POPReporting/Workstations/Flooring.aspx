<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Flooring.aspx.vb" Inherits="Workstations_Flooring" MaintainScrollPositionOnPostback="true" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:Table ID="tblHeader" runat="server" CssClass="auto-style1" Width="1400px" GridLines="None">
                <asp:TableRow>
                    <asp:TableCell>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            ...
            <ContentTemplate>
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Boat/Customer">
                            <ItemTemplate>
                                ...
                                <br />
                                <asp:Label ID="Label5" runat="server" Text='<%# "Line: " + Eval("BuildLoc")%>' CssClass="duedate"></asp:Label>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Floors">
                            <ItemTemplate>
                                <asp:ImageButton ID="btnUpdateFloors" runat="server" Enabled=' <%# Eval("FloorsInstalledStatus") >= 1%>' ImageUrl='<%# Eval("FloorsInstalledStatus", "../Images/framescomplete_status{0}.png")%>' CommandArgument="<%# Container.DataItemIndex %>" CommandName="gotoupdate" />
                            </ItemTemplate>
                        </asp:TemplateField>
                ...
                <asp:SqlDataSource ID="sdsPopReporting" runat="server" ConnectionString="<%$ ConnectionStrings:bml_dataConnectionString %>" SelectCommand="SELECT BML_POPREPORTING.ProdNo, BML_POPREPORTING.PopNo, BML_POPREPORTING.SoNo, BML_POPREPORTING.CusNo, BML_POPREPORTING.CusName, BML_POPREPORTING.ItemNo, BML_POPREPORTING.IsCustom, BML_POPREPORTING.IsPilot, BML_POPREPORTING_GREENLIGHTS.FurnitureStatus, BML_POPREPORTING_GREENLIGHTS.FiberglassStatus, BML_POPREPORTING_GREENLIGHTS.CoversStatus, BML_POPREPORTING_GREENLIGHTS.RailsStatus, BML_POPREPORTING_GREENLIGHTS.TubesStatus, BML_POPREPORTING_GREENLIGHTS.FramesInstalledStatus, BML_POPREPORTING_GREENLIGHTS.FloorsInstalledStatus, BML_POPREPORTING_GREENLIGHTS.CompleteStatus, BML_POPREPORTING_GREENLIGHTS.BoatHasNotes, BML_POPREPORTING_GREENLIGHTS.NotesFloors, BML_POPREPORTING_GREENLIGHTS.IsBoatOffline, BML_POPREPORTING_GREENLIGHTS.FramesInstalled, BML_POPREPORTING_GREENLIGHTS.BuildLoc,BML_POPREPORTING_GREENLIGHTS.CenterTubeStatus, BML_POPREPORTING_GREENLIGHTS.CentertubeNeeded, BML_POPREPORTING_GREENLIGHTS.QFrontNeeded, BML_POPREPORTING_GREENLIGHTS.QFrontStatus, BML_POPREPORTING_GREENLIGHTS.ArchTowerNeeded, BML_POPREPORTING_GREENLIGHTS.ArchTowerStatus, cast(BML_POPREPORTING_GREENLIGHTS.GaugeStatus as varchar) + cast(BML_POPREPORTING_GREENLIGHTS.HarnessStatus as varchar) as ElectricalStatus, BML_POPREPORTING_GREENLIGHTS.HelmBuildStatus, BML_POPREPORTING_GREENLIGHTS.SwingbackStatus, (CASE WHEN BML_POPREPORTING.ItemNo Like '%SB%' Then 1 ELSE 0 END) as SBShowFlag, BML_POPREPORTING_GREENLIGHTS.DueDate, FiberglassInspStatus, FiberglassInsp, HelmBuildStatus, HelmBuild FROM BML_POPREPORTING INNER JOIN BML_POPREPORTING_GREENLIGHTS ON BML_POPREPORTING.ProdNo = BML_POPREPORTING_GREENLIGHTS.ProdNo WHERE(BML_POPREPORTING.ProdNo = BML_POPREPORTING_GREENLIGHTS.ProdNo) AND (BML_POPREPORTING_GREENLIGHTS.CompleteStatus = @CompleteStatus) AND (BML_POPREPORTING_GREENLIGHTS.FloorsInstalledStatus = @FloorsInstalledStatus) AND (BML_POPREPORTING_GREENLIGHTS.ProdNo LIKE '%' + @Search + '%') AND (BML_POPREPORTING_GREENLIGHTS.BuildLoc LIKE '%' + @BuildLocation + '%') AND (BML_POPREPORTING.ItemNo LIKE '%' + @SearchBoat + '%') AND ((BML_POPREPORTING_GREENLIGHTS.BuildLoc = 'S') or ((BML_POPREPORTING_GREENLIGHTS.BuildLoc = 'M' or BML_POPREPORTING_GREENLIGHTS.BuildLoc = 'V') and (BML_POPREPORTING_GREENLIGHTS.FurnitureStatus &gt;= 2) AND (BML_POPREPORTING_GREENLIGHTS.FiberglassStatus = 2) AND (BML_POPREPORTING_GREENLIGHTS.CoversStatus &gt;= 1) AND (BML_POPREPORTING_GREENLIGHTS.RailsStatus = 2) AND (BML_POPREPORTING_GREENLIGHTS.GaugeStatus = 2) AND (BML_POPREPORTING_GREENLIGHTS.HarnessStatus = 2))) ORDER BY BML_POPREPORTING_GREENLIGHTS.FurnitureStatus Desc, BML_POPREPORTING_GREENLIGHTS.RailsStatus Desc, BML_POPREPORTING_GREENLIGHTS.RailsLastUpdated">
                    <SelectParameters>
