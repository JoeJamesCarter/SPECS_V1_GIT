<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Floors.aspx.vb" Inherits="Workstations_Floors" MaintainScrollPositionOnPostback="true"%>
...
<body>
    ...
    <div>
            <asp:Table ID="tblHeader" runat="server" CssClass="auto-style1" Width="1024px" GridLines="None">
                <asp:TableRow>
                    <asp:TableCell>
                        <span class="newStyle7">FLOORS</span><br />
            ...
            <Columns>
               ...
               <asp:ImageField DataImageUrlField="IsCustom" DataImageUrlFormatString="../Images/Custom{0}.png" HeaderText="Custom">
                ...
                <asp:TemplateField HeaderText="Floors">
                    <ItemTemplate>
                        <asp:ImageButton ID="btnUpdateFloors" runat="server"  Enabled =' <%# Eval("FloorsInstalledStatus") >= 1%>' ImageUrl='<%# Eval("FloorsInstalledStatus", "../Images/complete_status{0}.png")%>' CommandArgument="<%# Container.DataItemIndex %>"  CommandName="gotoupdate"/>                                           
                    </ItemTemplate>
                </asp:TemplateField>
