<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PhyInvNorth.aspx.vb" Inherits="PhyInv_PhyInvNorth" %>
        ...
        <div class="container-fluid">
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    ...
                    <asp:DataList ID="DataList1" runat="server" DataSourceID="sdsInventoryAreas" RepeatDirection="Horizontal" RepeatColumns="5" BorderStyle="Outset" SeparatorStyle-Height="2px" DataKeyField="Area" CellPadding="2" CellSpacing="2">
                        <ItemStyle BorderStyle="Solid" BorderWidth="0px" />
                        <ItemTemplate>
                    ...
                    <asp:SqlDataSource ID="sdsInventoryAreas" runat="server" ConnectionString="<%$ ConnectionStrings:InventoryConnectionString %>" SelectCommand="SELECT * FROM [Inventory] WHERE (Building = 'N') ORDER BY [Area]"></asp:SqlDataSource>
