<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PhyInvSouth.aspx.vb" Inherits="PhyInv_PhyInvSouth" %>
        ...
        <div class="container-fluid">
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    ...
                    <asp:SqlDataSource ID="sdsInventoryAreas" runat="server" ConnectionString="<%$ ConnectionStrings:InventoryConnectionString %>" SelectCommand="SELECT * FROM [Inventory] WHERE (Building = 'S') ORDER BY [Area]"></asp:SqlDataSource>
