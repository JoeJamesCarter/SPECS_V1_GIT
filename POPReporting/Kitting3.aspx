<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Kitting3.aspx.vb" Inherits="Kitting3" MaintainScrollPositionOnPostback="true" %>
            ...
            <asp:GridView ID="gvKitting" runat="server" AutoGenerateColumns="False" DataSourceID="sdsPopReporting" Height="177px" CellPadding="4" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellSpacing="2" CssClass="newStyle1" ForeColor="Black" DataKeyNames="ProdNo">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Update">
                        <ItemTemplate>
                            <div class="newStyle2">
                                <asp:RadioButtonList ID="rblKittingStatus" runat="server" SelectedValue='<%# Bind("Kitting3Status")%>' RepeatDirection="Horizontal" Width="274px">
