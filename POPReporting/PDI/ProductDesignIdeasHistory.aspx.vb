...
Partial Class PDI_ProductDesignIdeasHistory
    ...
    Protected Sub gvProjectIdeas_RowCommand(sender As Object, e As GridViewCommandEventArgs) Handles gvProjectIdeas.RowCommand
        If e.CommandName = "EditStatus" Then
            ...
            Response.Write("<script language='javascript'> {popUpObj=window.open ('" & url & "' ,'mywindow','menubar=0,resizable=1,width=1600,height=1000,toolbars=0');popUpObj.focus()}</script>")
