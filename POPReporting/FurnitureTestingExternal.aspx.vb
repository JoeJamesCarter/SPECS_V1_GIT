...
Partial Class FurnitureTestingExternal
    ...
    Protected Sub gvAllFieldsF_RowCommand(sender As Object, e As GridViewCommandEventArgs) Handles gvAllFieldsF.RowCommand
        ...
        If e.CommandName = "UpdateFStatus" Then
            ...
            'Dim connstr2 As String = ConfigurationManager.ConnectionStrings("SPECS_ExternalConnectionString").ConnectionString
            ...
            If greenlightcount = 1 Then '5 major greenlights are green
                ...
                End If
            Else
                ' cmd5.ExecuteNonQuery() 'was already commented out, don't re enable this.
            End If
            'conn.Close()
            conn2.Close()
        End If
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        'cmd5 = "SELECT Greenlights.F_Status, Greenlights.F_Enroute_Status, Greenlights.F_Est_ETA, Greenlights.F_Incomplete, Greenlights.F_Truck FROM Greenlights INNER JOIN Live_Boats ON Greenlights.ProdNo = Live_Boats.ProdNo"
        ...
        ' Dim adapter As MySqlDataAdapter = New MySqlDataAdapter(cmd5, conn2)
        'Dim veadainfo As DataSet = New DataSet
        'adapter.Fill(veadainfo, "Veada")
