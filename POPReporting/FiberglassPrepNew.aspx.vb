...
Partial Class FiberglassPrepNew
    ...
    Protected Sub gvAllFieldsF_RowCommand(sender As Object, e As GridViewCommandEventArgs) Handles gvAllFieldsFG.RowCommand
        ...
        If e.CommandName = "goto" Then 'handles when the notes button is clicked
            ...
            Dim workstation As String = "Fiberglass" 'to pass in the workstation that makes the note.
        ...
        If e.CommandName = "UpdateFGStatus" Then
            ...
            Dim rbList As RadioButtonList = DirectCast(gvAllFieldsFG.Rows(Key).Cells(4).FindControl("rblFiberglassStatus"), RadioButtonList)
            ...
            cmd.CommandText = "UPDATE BML_POPREPORTING_GREENLIGHTS SET FiberglassStatus = '" & rbList.SelectedValue & "' , FiberglassLastUpdated = '" & TodaysDate & "' where ProdNo =  '" & SelectedProdNo & "'"
