<%@ Page Language="VB" AutoEventWireup="false" CodeFile="KitReceivingRO.aspx.vb" Inherits="KitReceivingRO" MaintainScrollPositionOnPostback="true" %>
    ...
    <form id="form1" runat="server">
     <div>
            <asp:Table ID="tblHeader" runat="server" CssClass="auto-style1" Width="1024px" GridLines="None">
                <asp:TableRow>
                    <asp:TableCell>
                        <span class="newStyle7">KIT RECEIVING RO</span><br />
...
<ItemStyle HorizontalAlign="Center"></ItemStyle>
               ...
               <asp:ImageField DataImageUrlField="IsCustom" DataImageUrlFormatString="Images/Custom{0}.png" HeaderText="Custom">
                ...
                <asp:TemplateField HeaderText="Assembly">
                    <ItemTemplate>
                        <asp:ImageButton ID="btnAssembly" runat="server" ImageUrl='<%# Eval("Kit1RcvStatus", "Images/kitrcv{0}.png")%>' CommandArgument="<%# Container.DataItemIndex %>" ToolTip='<%# Eval("Kit1Rcv")%>' />
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Furniture">
                    <ItemTemplate>
                        <asp:ImageButton ID="btnFurniture" runat="server" ImageUrl='<%# Eval("Kit3RcvStatus", "Images/kitrcv{0}.png")%>' CommandArgument="<%# Container.DataItemIndex %>" ToolTip='<%# Eval("Kit3Rcv")%>'/>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Final">
                    <ItemTemplate>
                        <asp:ImageButton ID="btnFinal" runat="server" ImageUrl='<%# Eval("Kit4RcvStatus", "Images/kitrcv{0}.png")%>' CommandArgument="<%# Container.DataItemIndex %>" ToolTip='<%# Eval("Kit4Rcv")%>'/>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="South">
                    <ItemTemplate>
                        <asp:ImageButton ID="btnSouth" runat="server" ImageUrl='<%# Eval("Kit5RcvStatus", "Images/kitrcv{0}.png")%>' CommandArgument="<%# Container.DataItemIndex %>" ToolTip='<%# Eval("Kit5Rcv")%>'/>
                    </ItemTemplate>
                </asp:TemplateField>
                 <asp:TemplateField HeaderText="Trim">
                    <ItemTemplate>
                        <asp:ImageButton ID="btnTrim" runat="server" ImageUrl='<%# Eval("Kit2RcvStatus", "Images/kitrcv{0}.png")%>' CommandArgument="<%# Container.DataItemIndex %>" ToolTip='<%# Eval("Kit2Rcv")%>'/>
                    </ItemTemplate>
                </asp:TemplateField>
