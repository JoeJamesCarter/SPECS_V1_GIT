...
Partial Class Swingbacks
    ...
    Protected Sub gvAllFieldsF_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles gvAllFieldsF.RowDataBound
        ...
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            If e.Row.DataItem("FurnitureStatus") >= 2 And e.Row.DataItem("FiberglassStatus") = 2 And e.Row.DataItem("CoversStatus") >= 1 And (e.Row.DataItem("RailsStatus") > 0 Or e.Row.DataItem("HasAllRails") = 1) And e.Row.DataItem("GaugeStatus") = 2 And e.Row.DataItem("HarnessStatus") = 2 And e.Row.DataItem("FloorsInstalledStatus") = 1 Then
                e.Row.BackColor = Drawing.Color.LightGreen
            End If

            'If e.Row.DataItem("FurnitureStatus") >= 2 And e.Row.DataItem("FiberglassStatus") = 2 And e.Row.DataItem("CoversStatus") >= 1 And (e.Row.DataItem("RailsStatus") > 0 Or e.Row.DataItem("HasAllRails") = 1) And e.Row.DataItem("GaugeStatus") = 2 And e.Row.DataItem("HarnessStatus") = 2 And e.Row.DataItem("FloorsInstalledStatus") = 2 Then
            '    e.Row.BackColor = Drawing.Color.LightGreen
            'End If
    ...
    Protected Sub gvAllFieldsF_RowCommand(sender As Object, e As GridViewCommandEventArgs) Handles gvAllFieldsF.RowCommand
        ...
        If e.CommandName = "UpdateSBStatus" Then
            ...
            cmd.CommandText = "UPDATE BML_POPREPORTING_GREENLIGHTS SET SwingbackStatus = '" & rbList.SelectedValue & "' , Swingback = '" & TodaysDate & "' where ProdNo =  '" & SelectedProdNo & "'"
            cmd2.CommandText = "Select Count (*) FROM BML_POPREPORTING_GREENLIGHTS where SwingbackStatus = 2 and Convert(date,Swingback) ='" & ThisDay & "'"
