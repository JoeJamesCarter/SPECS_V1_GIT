...
Partial Class Inspections_Inspectors
    ...
    Protected Sub gvOverview_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles gvOverview.RowDataBound
        ...
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            e.Row.Cells(3).ToolTip = "Boat/Customer"
            e.Row.Cells(4).ToolTip = "Tubes"
            'e.Row.Cells(5).ToolTip = "Floors"
            'e.Row.Cells(6).ToolTip = "Trim"
            'e.Row.Cells(7).ToolTip = "Rails"
            'e.Row.Cells(8).ToolTip = "Furniture"
            'e.Row.Cells(9).ToolTip = "Helm"
            'e.Row.Cells(10).ToolTip = "Inspection"
            'e.Row.Cells(11).ToolTip = "Final Inspection"
            'e.Row.Cells(12).ToolTip = "Shrinkwrap"
            'e.Row.Cells(13).ToolTip = "Rigging"
            'e.Row.Cells(14).ToolTip = "Wavetamer"
            'e.Row.Cells(15).ToolTip = "Sharkhide"
            'e.Row.Cells(16).ToolTip = "Complete"
    ...
    Protected Sub gvOverview_RowCommand(sender As Object, e As GridViewCommandEventArgs) Handles gvOverview.RowCommand
        ...
        If e.CommandName = "gototubeinsp" Then
            gvOverview.DataBind()
            Dim Selected As String = e.CommandArgument 'find the prod # in that row to use in the update command

            Dim url As String = "./TubeInspections.aspx?ProdNo=" & Selected
