...
<div>
    <asp:table id="Table1" runat="server" cssclass="auto-style1" width="1103px" gridlines="None">
    ...
    <asp:button runat="server" text="Clear" id="btnClear" onclick="btnClear_Click" /></span>
             ...
             <asp:TableCell>
             <span class="newStyle3">Sort By&nbsp;&nbsp;</span>
                 <asp:DropDownList ID="ddlSort" runat="server" AutoPostBack="True">                             
                <asp:ListItem Value="GreenStatusTotal">Most Green</asp:ListItem>   
                      <asp:ListItem Value="BML_POPREPORTING.ProdNo">Prod #</asp:ListItem>               
            </asp:DropDownList></span>
              </asp:TableCell> 
