<%@ Page Language="VB" AutoEventWireup="false" CodeFile="EditStatusRO.aspx.vb" Inherits="SRT_EditStatusRO" %>
        ...
        <asp:Label ID="Label2" runat="server" Text="Item Category:  " CssClass="newStyle6"></asp:Label><asp:Label ID="lblItemDesc" runat="server" Text="" CssClass="newStyle6"></asp:Label>
            ...
            <div id="editContainer">
                <div id="left">
                    ...
                    <asp:SqlDataSource ID="sdsThisItem" runat="server" ConnectionString="<%$ ConnectionStrings:bml_dataConnectionString %>" DeleteCommand="DELETE FROM [SupplierTracking_Items] WHERE [ItemID] = @ItemID" InsertCommand="INSERT INTO [SupplierTracking_Items] ([ModelYear], [Category], [Supplier], [Color_Type], [DependentOn], [LeadTime], [DependentOnItemsList]) VALUES (@ModelYear, @Category, @Supplier, @Color_Type, @DependentOn, @LeadTime, @DependentOnItemsList)" SelectCommand="SELECT * FROM [SupplierTracking_Items] WHERE ([ItemID] = @ItemID)" UpdateCommand="UPDATE [SupplierTracking_Items] SET [ModelYear] = @ModelYear, [Category] = @Category, [Supplier] = @Supplier, [Color_Type] = @Color_Type, [DependentOn] = @DependentOn, [LeadTime] = @LeadTime, [DependentOnItemsList] = @DependentOnItemsList WHERE [ItemID] = @ItemID">
                        <DeleteParameters>
                ...
                <div id="right">
                    ...
                    <br />
                    <asp:Button ID="btnUpdateTriggers" runat="server" Text="Update Triggers" Visible="False" />
                    <br />
                </div>
            </div>
            <div id="bottom">
                ...
                <br />
                <hr />
                <asp:Label ID="Label12" runat="server" Text="Upload Attachments:" CssClass="newStyle4" Visible="False"></asp:Label>
                &nbsp;
                <asp:FileUpload ID="File1" runat="server" Width="381px" Visible="False" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <asp:Button ID="btnUpload" runat="server" Text="Upload" Visible="False" />
                &nbsp;&nbsp;&nbsp;
                ...
                <hr />
                <br />
                <asp:Label ID="Label9" runat="server" Text="Add Status/Notes:" CssClass="newStyle4" Visible="False"></asp:Label>
                <br />
                <br />
                <asp:Label ID="Label4" runat="server" CssClass="newStyle6" Text="Model Year:  " Width="100px" Visible="False"></asp:Label>
                <asp:DropDownList ID="ddlModelYear" runat="server" Visible="False">
                ...
                <br />
                <asp:Label ID="Label5" runat="server" CssClass="newStyle6" Text="Week Of:  " Width="100px" Visible="False"></asp:Label>
                <asp:DropDownList ID="ddlWeekOf" runat="server" Visible="False">
                </asp:DropDownList>
                <br />
                <asp:Label ID="Label6" runat="server" CssClass="newStyle6" Text="Status:  " Width="100px" Visible="False"></asp:Label>
                <asp:DropDownList ID="ddlStatuses" runat="server" DataSourceID="sdsStatuses" DataTextField="StatusDesc" DataValueField="Status" Visible="False">
                </asp:DropDownList>
                ...
                <br />
                <br />
                <asp:Label ID="Label7" runat="server" CssClass="newStyle6" Text="Notes:  " Width="100px" Visible="False"></asp:Label><asp:TextBox ID="tbNote" runat="server" Height="66px" TextMode="MultiLine" Width="330px" Visible="False"></asp:TextBox>
                &nbsp;
        <asp:Button ID="btnSave" runat="server" Text="Save" Height="36px" Width="144px" Visible="False" />
            </div>
        </div>
    </form>
</body>
