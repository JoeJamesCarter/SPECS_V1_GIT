<%@ Page Language="VB" AutoEventWireup="false" CodeFile="SupplierReadinessTracking.aspx.vb" Inherits="SRT_SupplierReadinessTracking" MaintainScrollPositionOnPostback="true" Debug="true" EnableEventValidation="false"%>
...
<body>
    <form id="form1" runat="server">
        ...
        &nbsp;&nbsp;&nbsp;
        <asp:Button ID="btnShowAddItemForm" runat="server" Text="Show Add Item" />
        &nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Button ID="btnHideAddItemForm" runat="server" Text="Hide Add Item" Visible="False" />
        &nbsp;&nbsp;&nbsp;
        <asp:Button ID="btnMaintainMileStones" runat="server" Text="Show/Hide Add Milestones " />
        &nbsp;&nbsp;&nbsp;       
        ...
        <div id="milestones">
            ...
            <asp:Label ID="Label22" runat="server" Text="Filter By Current Status" CssClass="newStyle6" Width="187px"></asp:Label>
            <asp:DropDownList ID="ddlStatuses" runat="server" AppendDataBoundItems="True" AutoPostBack="True" DataSourceID="sdsStatuses" DataTextField="StatusDesc" DataValueField="Status" Visible="False">
                   <asp:ListItem Text="All" Value="%" />
            </asp:DropDownList>
&nbsp;&nbsp;&nbsp;
            <asp:CheckBoxList ID="cbCurrentStatusFilter" runat="server" AppendDataBoundItems="True" AutoPostBack="True" DataSourceID="sdsStatuses" DataTextField="StatusDesc" DataValueField="Status" RepeatDirection="Horizontal" CssClass="newStyle1">
                       ...
                       <asp:BoundField DataField="ItemID" HeaderText="ID" InsertVisible="False" ReadOnly="True" SortExpression="ItemID">
                        ...
                        <asp:TemplateField HeaderText="Category">
                            ...
                            <ItemTemplate>
                                ...
                                <asp:HiddenField runat="server" ID="hdnMaxStatus"></asp:HiddenField>
                            </ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Current Status">
                            ...
                            <ItemTemplate>
                                ...
                                <asp:SqlDataSource ID="sdsMaxStatus" runat="server" ConnectionString="<%$ ConnectionStrings:bml_dataConnectionString %>" SelectCommand="SELECT [WeekOf], [Status],[Notes], [Status] as MaxStatus FROM [SupplierReadiness_StatusNotes] WHERE ([ItemID] = @ItemID) AND EntryID = (select max(EntryID) from SupplierReadiness_StatusNotes Where [ItemID] = @ItemID2)">
                                    <SelectParameters>
                                        <asp:Parameter Name="ItemID" Type="Int32" />
                                        <asp:Parameter Name="ItemID2" Type="Int32" />
                                    </SelectParameters>
