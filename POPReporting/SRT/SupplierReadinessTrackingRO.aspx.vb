...
Partial Class SRT_SupplierReadinessTrackingRO
    ...
    Protected Sub gvItems_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles gvItems.RowDataBound
        ...
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            Dim currentStatus As String = e.Row.Cells(11).Text
            ...
            statusResult = StatusandNotesList.Select("ItemID =  '" & itemID & "'")
            Dim i As Integer = 0
            ...
            If lateFlag = 1 And ThreeWeeksTilDropDead < Today() Then
                e.Row.Cells(2).BackColor = Drawing.Color.Yellow
            End If

            If lateFlag = 1 And TwoWeeksTilDropDead < Today() Then
                e.Row.Cells(2).BackColor = Drawing.Color.Orange
            End If

            If lateFlag = 1 And dropDead < Today() Then
    ...
    Protected Function PopulateDataTables() As String  'store distinct prods with rgas and bos so you don't have to scan everything
        ...
        sqldataadapter.SelectCommand = New SqlCommand("Select * FROM SupplierReadiness_StatusNotes Order By ItemID, WeekOf , EntryID", conn)
    ...
    Protected Sub gvItems_RowCommand(sender As Object, e As GridViewCommandEventArgs) Handles gvItems.RowCommand
        If e.CommandName = "EditStatus" Then
            ...
            Dim url As String = "./EditStatusRO.aspx?ItemID=" & ItemID & "&ItemDesc=" & ItemDesc & "&Dependency=" & Dependency
