...
<div>
    <asp:table id="Table1" runat="server" cssclass="auto-style1" width="100%" gridlines="None">
    ...
    <asp:button runat="server" text="Clear" id="btnClear" onclick="btnClear_Click" /></span>
            ...
            <asp:TableCell rowspan="2" width="200px">
                <asp:HyperLink runat="server" Target="_blank" NavigateUrl="./Tubes/ReprintTubeLabels.aspx">Reprint Labels</asp:HyperLink><br /><br /><asp:HyperLink runat="server" Target="_blank" NavigateUrl="./Tubes/RerunHistory.aspx">Re-Run History</asp:HyperLink>
            </asp:TableCell>
        </asp:TableRow>
        <asp:TableRow runat="server">
