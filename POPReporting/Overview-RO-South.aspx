<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Overview-RO-South.aspx.vb" Inherits="Overview_RO_South" %>
    ...
    <div>
        ...
        <asp:GridView ID="gvOverview" runat="server" AutoGenerateColumns="False" CssClass="newStyle1" DataKeyNames="ProdNo" DataSourceID="sdsPopReporting" CellPadding="5" PageSize="15">
            <Columns>
                ...
                <asp:ImageField DataImageUrlField="CleaningStatus" DataImageUrlFormatString="./Images/complete_status{0}.png" HeaderText="Cleaning">
                    <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                </asp:ImageField>
