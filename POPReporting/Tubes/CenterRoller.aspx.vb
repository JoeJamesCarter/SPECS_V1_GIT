...
Partial Class Tubes_CenterRoller
    ...
    Protected Sub gvRoller_RowCommand(sender As Object, e As GridViewCommandEventArgs) Handles gvRoller.RowCommand
        ...
        If e.CommandName = "gotoupdateCtr" Then
            ...
            cmd7.CommandText = "UPDATE Tubes SET RollerCStatus = '2', RoundSeamerCStatus = '1', RollerC = '" & TodaysDate & "' where ProdNo =  '" & SelectedProdNo & "'"
        ...
        If e.CommandName = "gotoupdateP" Then
            ...
            cmd7.CommandText = "UPDATE Tubes SET RollerPStatus = '2', RoundSeamerPStatus = '1', RollerP = '" & TodaysDate & "' where ProdNo =  '" & SelectedProdNo & "'"
        ...
        If e.CommandName = "gotoupdateS" Then
            ...
            cmd7.CommandText = "UPDATE Tubes SET RollerSStatus = '2', RoundSeamerSStatus = '1', RollerS = '" & TodaysDate & "' where ProdNo =  '" & SelectedProdNo & "'"
    ...
    Protected Sub gvRoller_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles gvRoller.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            If (e.Row.DataItem("RerunCtr") > 1) Or (e.Row.DataItem("ItemNo").ToString Like "*X1" And e.Row.DataItem("RerunSB") > 1) Or (e.Row.DataItem("ItemNo").ToString Like "*X2" And e.Row.DataItem("RerunP") > 1) Then
