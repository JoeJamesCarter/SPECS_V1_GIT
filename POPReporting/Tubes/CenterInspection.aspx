<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CenterInspection.aspx.vb" Inherits="Tubes_CenterInspection"  MaintainScrollPositionOnPostback="true"%>
...
<body>
    ...
    <div>
          <asp:Table ID="tblHeader" runat="server" CssClass="auto-style1" Width="1024px" GridLines="None">
                <asp:TableRow>
                    <asp:TableCell>
                        <span class="newStyle7">CENTER INSPECTION</span><br />
            ...
            <Columns>
               ...
               <asp:ImageField DataImageUrlField="IsCustom" DataImageUrlFormatString="../Images/Custom{0}.png" HeaderText="Custom">
                ...
                <asp:TemplateField HeaderText="Inspect">
                         <ItemTemplate>
                             <asp:ImageButton ID="btnInspCtr" runat="server" CommandArgument="<%# Container.DataItemIndex %>" CommandName="gotoInspectCtr" ImageUrl='<%# Eval("InspectionStatus", "../Images/inspection{0}.png")%>' />
                         </ItemTemplate>
                     </asp:TemplateField>
        ...
        <asp:SqlDataSource ID="sdsPopReporting" runat="server" ConnectionString="<%$ ConnectionStrings:bml_dataConnectionString %>" SelectCommand="SELECT BML_POPREPORTING.ProdNo, BML_POPREPORTING.PopNo, BML_POPREPORTING.CusNo, BML_POPREPORTING.SONo, BML_POPREPORTING.CusName, BML_POPREPORTING.ItemNo, BML_POPREPORTING.IsCustom, BML_POPREPORTING.CentertubeNeeded, BML_POPREPORTING_GREENLIGHTS.FurnitureStatus, BML_POPREPORTING_GREENLIGHTS.FiberglassStatus, BML_POPREPORTING_GREENLIGHTS.CoversStatus, BML_POPREPORTING_GREENLIGHTS.RailsStatus, BML_POPREPORTING_GREENLIGHTS.TubesStatus,  BML_POPREPORTING_GREENLIGHTS.CentertubeStatus, BML_POPREPORTING_GREENLIGHTS.BoatHasNotes,BML_POPREPORTING_GREENLIGHTS.IsBoatOffline, CenterInspection.InspectionStatus, CenterInspection.InspectionNotes, BML_POPREPORTING_GREENLIGHTS.BuildLoc FROM BML_POPREPORTING INNER JOIN BML_POPREPORTING_GREENLIGHTS ON BML_POPREPORTING.ProdNo = BML_POPREPORTING_GREENLIGHTS.ProdNo Left Join CenterInspection on BML_POPREPORTING.ProdNo = CenterInspection.ProdNo WHERE(BML_POPREPORTING.ProdNo = BML_POPREPORTING_GREENLIGHTS.ProdNo) AND (BML_POPREPORTING_GREENLIGHTS.CompleteStatus = @CompleteStatus) AND (BML_POPREPORTING.DueDate &lt;= @DueDate) AND (CenterInspection.InspectionStatus &lt;= @InspectionStatus) AND (BML_POPREPORTING_GREENLIGHTS.CentertubeNeeded = '1') AND (BML_POPREPORTING_GREENLIGHTS.ProdNo LIKE '%' + @Search + '%') AND (BML_POPREPORTING.ItemNo LIKE '%' + @SearchBoat + '%') ORDER BY BML_POPREPORTING.ProdNo">
            <SelectParameters>
                ...
                <asp:Parameter DefaultValue="1" Name="CentertubeNeeded" Type="Int32" />
                 ...
                 <asp:ControlParameter ControlID="ddlShowSelect" Name="InspectionStatus" PropertyName="SelectedValue" Type="Int32" DefaultValue="2" />
