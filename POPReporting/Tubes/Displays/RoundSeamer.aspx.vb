...
Partial Class Tubes_Displays_RoundSeamer
    ...
    Protected Sub dl1_DataBinding(sender As Object, e As EventArgs) Handles dl1.DataBinding
        ...
        cmd2.CommandText = "Select Count (*) FROM Tubes where (RoundSeamerCStatus = 2 and Convert(date,RoundSeamerC) ='" & ThisDay & "')"
        cmd3.CommandText = "Select Count (*) FROM Tubes where (RoundSeamerPStatus = 2 and Convert(date,RoundSeamerP) ='" & ThisDay & "')"
        cmd4.CommandText = "Select Count (*) FROM Tubes where (RoundSeamerSStatus = 2 and Convert(date,RoundSeamerS) ='" & ThisDay & "')"
