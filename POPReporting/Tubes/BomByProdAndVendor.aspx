<%@ Page Language="VB" AutoEventWireup="false" CodeFile="BomByProdAndVendor.aspx.vb" Inherits="BOMs_BomByProdAndVendor" Debug="true" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:DropDownList runat="server" ID="ddlVendors" DataSourceID="sdsVendors" DataTextField="vend_name" DataValueField="vend_no" AppendDataBoundItems="true">
                <asp:ListItem></asp:ListItem>
            </asp:DropDownList>
             <asp:Button ID="btnGetPartsByVendor"  CssClass="newStyle1" runat="server" Text="Load Parts By Vendor" />&nbsp;&nbsp;&nbsp;&nbsp;




            <asp:SqlDataSource runat="server" ID="sdsVendors" ConnectionString='<%$ ConnectionStrings:dataConnectionString %>' SelectCommand="SELECT [vend_no], [vend_name] FROM [apvenfil_sql] Where vend_no = '469440' ORDER BY [vend_name]"></asp:SqlDataSource>
            <asp:GridView ID="gvExplode" runat="server" AutoGenerateColumns="False" Caption="All Levels Grouped" CssClass="newStyle1" Visible="False">
                <Columns>
            ...
            <asp:GridView ID="gvpoordlin" runat="server" CssClass="newStyle1" Caption="Vendor Parts"></asp:GridView>
        </div>
    </form>
</body>
</html>
