<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Roller.aspx.vb" Inherits="Tubes_Roller" MaintainScrollPositionOnPostback="true"  %>
<!DOCTYPE html>
...
<body>
    ...
    <div>
          <asp:Table ID="tblHeader" runat="server" CssClass="auto-style1" Width="1024px" GridLines="None">
                <asp:TableRow>
                    <asp:TableCell>
                        <span class="newStyle7">ROLLER</span><br />
            ...
            <Columns>
               ...
               <asp:ImageField DataImageUrlField="IsCustom" DataImageUrlFormatString="../Images/Custom{0}.png" HeaderText="Custom">
                ...
                <asp:TemplateField HeaderText="Port">
                    <ItemTemplate>
                        <asp:ImageButton ID="btnUpdateRollerP" runat="server"  Enabled =' <%# Eval("RollerStatusP") >= 1%>' ImageUrl='<%# Eval("RollerStatusP", "../Images/complete_status{0}.png")%>' CommandArgument="<%# Container.DataItemIndex %>" CommandName="gotoupdateP"/>                                           
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Starboard">
                    <ItemTemplate>
                        <asp:ImageButton ID="btnUpdateRollerS" runat="server"  Enabled =' <%# Eval("RollerStatusS") >= 1%>' ImageUrl='<%# Eval("RollerStatusS", "../Images/complete_status{0}.png")%>' CommandArgument="<%# Container.DataItemIndex %>" CommandName="gotoupdateS"/>                                           
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Express">
                    <ItemTemplate>
                        <asp:ImageButton ID="btnUpdateRollerCtr" runat="server"  Enabled =' <%# Eval("RollerStatusCtr") >= 1%>' Visible=' <%# Eval("Express") = 1%>' ImageUrl='<%# Eval("RollerStatusCtr", "../Images/complete_status{0}.png")%>' CommandArgument="<%# Container.DataItemIndex %>" CommandName="gotoupdateCtr"/>                                           
                    </ItemTemplate>
                </asp:TemplateField>                
