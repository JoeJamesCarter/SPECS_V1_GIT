...
Partial Class Tubes_RoundSeamer
    ...
    Protected Sub gvRoundSeamer_RowCommand(sender As Object, e As GridViewCommandEventArgs) Handles gvRoundSeamer.RowCommand
        ...
        'This code is for the update button for Port
        If e.CommandName = "gotoupdateP" Then
            ...
            Dim img As Image = CType(gvRoundSeamer.Rows(Key).FindControl("btnUpdateRoundSeamerP"), Image)
            ...
            cmd.CommandText = "UPDATE BML_POPREPORTING_GREENLIGHTS SET RoundSeamerStatusP = '2', BracketsStatusP = '1', RoundSeamer = '" & TodaysDate & "' where ProdNo =  '" & SelectedProdNo & "'"
            cmd2.CommandText = "Select Count (*) FROM BML_POPREPORTING_GREENLIGHTS where RoundSeamerStatusS = 2 and RoundSeamerStatusP = 2 and Convert(date,RoundSeamer) ='" & ThisDay & "'"
            'Determine if the next workstation already has a done date set.
            cmd3.CommandText = "Select Count (*) FROM BML_POPREPORTING_GREENLIGHTS where BracketsStatusP = 2 and ProdNo = '" & SelectedProdNo & "'"
            'reverse done
            cmd4.CommandText = "UPDATE BML_POPREPORTING_GREENLIGHTS SET RoundSeamerStatusP = '1', BracketsStatusP = '0', RoundSeamer = NULL where ProdNo =  '" & SelectedProdNo & "'"
        ...
        'This code is for the update button for Starboard
        If e.CommandName = "gotoupdateS" Then
            Dim Key As String = e.CommandArgument 'get the row that is clicked
            Dim SelectedProdNo As Integer = gvRoundSeamer.Rows(Key).Cells(0).Text 'find the prod # in that row to use in the update command
            Dim img As Image = CType(gvRoundSeamer.Rows(Key).FindControl("btnUpdateRoundSeamerS"), Image)
            Dim framevalue = img.ImageUrl
            framevalue = Mid(framevalue, 26, 1) 'get the value of FramesInstalledStatus from the imageurl. Get 1 character after 32.
            ...
            'to get the count of the prod #'s completed that day as it changes
            cmd.CommandText = "UPDATE BML_POPREPORTING_GREENLIGHTS SET RoundSeamerStatusS = '2', BracketsStatusS = '1', RoundSeamer = '" & TodaysDate & "' where ProdNo =  '" & SelectedProdNo & "'"
            cmd2.CommandText = "Select Count (*) FROM BML_POPREPORTING_GREENLIGHTS where RoundSeamerStatusS = 2 and RoundSeamerStatusP = 2 and Convert(date,RoundSeamer) ='" & ThisDay & "'"
            'Determine if the next workstation already has a done date set.
            cmd3.CommandText = "Select Count (*) FROM BML_POPREPORTING_GREENLIGHTS where BracketsStatusS = 2 and ProdNo = '" & SelectedProdNo & "'"
            'reverse done
            cmd4.CommandText = "UPDATE BML_POPREPORTING_GREENLIGHTS SET RoundSeamerStatusS = '1', BracketsStatusS = '0', RoundSeamer = NULL where ProdNo =  '" & SelectedProdNo & "'"
        ...
        If e.CommandName = "gotoupdateCtr" Then
            Dim Key As String = e.CommandArgument 'get the row that is clicked
            Dim SelectedProdNo As Integer = gvRoundSeamer.Rows(Key).Cells(0).Text 'find the prod # in that row to use in the update command
            Dim img As Image = CType(gvRoundSeamer.Rows(Key).FindControl("btnUpdateRoundSeamerCtr"), Image)
            Dim framevalue = img.ImageUrl
            framevalue = Mid(framevalue, 26, 1) 'get the value of FramesInstalledStatus from the imageurl. Get 1 character after 32.
            ...
            'to get the count of the prod #'s completed that day as it changes
            cmd.CommandText = "UPDATE BML_POPREPORTING_GREENLIGHTS SET RoundSeamerStatusCtr = '2', BracketsStatusCtr = '1', RoundSeamerCtr = '" & TodaysDate & "' where ProdNo =  '" & SelectedProdNo & "'"
            cmd2.CommandText = "Select Count (*) FROM BML_POPREPORTING_GREENLIGHTS where RoundSeamerStatusCtr = 2 and Convert(date,RoundSeamerCtr) ='" & ThisDay & "'"
            'Determine if the next workstation already has a done date set.
            cmd3.CommandText = "Select Count (*) FROM BML_POPREPORTING_GREENLIGHTS where BracketsStatusCtr = 2 and ProdNo = '" & SelectedProdNo & "'"
            'reverse done
            cmd4.CommandText = "UPDATE BML_POPREPORTING_GREENLIGHTS SET RoundSeamerStatusCtr = '1', BracketsStatusCtr = '0', RoundSeamerCtr = NULL where ProdNo =  '" & SelectedProdNo & "'"
    ...
    Protected Sub gvRoundSeamer_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles gvRoundSeamer.RowDataBound
