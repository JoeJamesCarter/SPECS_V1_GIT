...
Partial Class BOMs_BomByProdAndVendor
    ...
    Public poordlin As New DataTable 'Purchased Parts
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Try
            ...
            If BoatSONo.Length > 0 Then
                ...
                'need to loop this function once for each prod # scheduled to have tubes made.
                'careful bc if you do centers and outers you will double dip.
    ...
    Private Sub btnGetPartsByVendor_Click(sender As Object, e As EventArgs) Handles btnGetPartsByVendor.Click
        GetPurchasedPartsVendors(ddlVendors.SelectedValue)
    End Sub

    Public Function GetPurchasedPartsVendors(vendno As String) As String
        ...
        SqlDataAdapter.SelectCommand = New SqlCommand("SELECT Distinct(item_no) as item_no, vend_no, item_desc_1 FROM [POORDLIN_SQL] Where vend_no = " & vendno & "", conn)
        SqlDataAdapter.Fill(poordlin)
        gvpoordlin.DataSource = poordlin
        gvpoordlin.DataBind()
    End Function
    ...
    Private Sub gvAllLevels_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles gvAllLevels.RowDataBound
        ...
        If poordlin.Rows.Count = 0 Then
            GetPurchasedPartsVendors(ddlVendors.SelectedValue)
        End If


        Try
            Dim partno As String = e.Row.DataItem("component_item")
            Dim partno2 As String = e.Row.DataItem("bomparent_item")
            Dim partno3 As String = e.Row.DataItem("parent_item_no")

            Dim partnorows = poordlin.Select("item_no  = '" & partno & "'")
            Dim partnorows2 = poordlin.Select("item_no  = '" & partno2 & "'")
            Dim partnorows3 = poordlin.Select("item_no  = '" & partno3 & "'")

            If partnorows.Length > 0 Then
                e.Row.Cells(8).BackColor = System.Drawing.Color.Red
            ElseIf partnorows2.Length > 0 Then
                e.Row.Cells(5).BackColor = System.Drawing.Color.Red
            ElseIf partnorows3.Length > 0 Then
