<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Seamer.aspx.vb" Inherits="Tubes_Seamer" MaintainScrollPositionOnPostback="true" Debug ="true"%>
          ...
          <asp:Table ID="tblHeader" runat="server" CssClass="auto-style1" Width="1024px" GridLines="None">
                <asp:TableRow>
                    <asp:TableCell Wrap="false">
                        <span class="newStyle7">SEAMER</span><br />
                ...
                <asp:TemplateField HeaderText="Sections">
                    ...
                    <asp:Table runat="server" BorderWidth="1" BorderStyle="Solid" GridLines="Both" Width="300px">
                     <asp:TableRow>
                        ...
                        <asp:TableCell>
                           <asp:ImageButton ID="btnUpdateSeamerPF" runat="server"  ImageUrl='<%# Eval("SeamerSectPFStatus", "../Images/tubesections_front{0}.png")%>' CommandArgument="<%# Container.DataItemIndex %>" CommandName="gotoupdatePF"/>                                           
                        </asp:TableCell>
                        <asp:TableCell style='<%# CheckMidVisible(Eval("CenterSections")) %>'>
                            <asp:ImageButton ID="btnUpdateSeamerPM" runat="server" Visible='<%#Eval("OuterSections") >= 3%>' ImageUrl='<%# Eval("SeamerSectPMStatus", "../Images/tubesections_mid{0}.png")%>' CommandArgument="<%# Container.DataItemIndex %>" CommandName="gotoupdatePM"/>                                           
                        </asp:TableCell>
                        <asp:TableCell style='<%# CheckMid2Visible(Eval("CenterSections")) %>'>
                          <asp:ImageButton ID="btnUpdateSeamerPM2" runat="server" Visible='<%#Eval("OuterSections") = 4%>' ImageUrl='<%# Eval("SeamerSectPM2Status", "../Images/tubesections_mid2{0}.png")%>' CommandArgument="<%# Container.DataItemIndex %>" CommandName="gotoupdatePM2"/>                                           
                        </asp:TableCell>
                        <asp:TableCell>
                             <asp:ImageButton ID="btnUpdateSeamerPR" runat="server"  ImageUrl='<%# Eval("SeamerSectPRStatus", "../Images/tubesections_rear{0}.png")%>' CommandArgument="<%# Container.DataItemIndex %>" CommandName="gotoupdatePR" />                                         
                        </asp:TableCell>
                    </asp:TableRow>
                        <asp:TableRow>
                        <asp:TableCell Font-Bold="True">
                         ...
                         <asp:TableCell>
                           <asp:ImageButton ID="btnUpdateSeamerSF" runat="server"  ImageUrl='<%# Eval("SeamerSectSFStatus", "../Images/tubesections_front{0}.png")%>' CommandArgument="<%# Container.DataItemIndex %>" CommandName="gotoupdateSF"/>                                           
                        </asp:TableCell>
                        <asp:TableCell style='<%# CheckMidVisible(Eval("CenterSections")) %>'>
                            <asp:ImageButton ID="btnUpdateSeamerSM" runat="server" Visible='<%#Eval("OuterSections") >= 3%>' ImageUrl='<%# Eval("SeamerSectSMStatus", "../Images/tubesections_mid{0}.png")%>' CommandArgument="<%# Container.DataItemIndex %>" CommandName="gotoupdateSM"/>                                           
                        </asp:TableCell>
                        <asp:TableCell  style='<%# CheckMid2Visible(Eval("CenterSections")) %>'>
                          <asp:ImageButton ID="btnUpdateSeamerSM2" runat="server" Visible='<%#Eval("OuterSections") = 4%>' ImageUrl='<%# Eval("SeamerSectSM2Status", "../Images/tubesections_mid2{0}.png")%>' CommandArgument="<%# Container.DataItemIndex %>" CommandName="gotoupdateSM2"/>                                           
                        </asp:TableCell>
                        <asp:TableCell>
                             <asp:ImageButton ID="btnUpdateSeamerSR" runat="server"  ImageUrl='<%# Eval("SeamerSectSRStatus", "../Images/tubesections_rear{0}.png")%>' CommandArgument="<%# Container.DataItemIndex %>" CommandName="gotoupdateSR" />                                         
                        </asp:TableCell>
                    </asp:TableRow>    
                        ...
                        <asp:TableCell Font-Bold="True">
                         ...
                         <asp:TableCell>
                           <asp:ImageButton ID="btnUpdateSeamerCF" runat="server"  ImageUrl='<%# Eval("SeamerSectCFStatus", "../Images/tubesections_front{0}.png")%>' CommandArgument="<%# Container.DataItemIndex %>" CommandName="gotoupdateCF"/>                                           
                        </asp:TableCell>
                        <asp:TableCell style='<%# CheckMidVisible(Eval("CenterSections")) %>'>
                            <asp:ImageButton ID="btnUpdateSeamerCM" runat="server" Visible='<%#Eval("CenterSections") >= 3%>' ImageUrl='<%# Eval("SeamerSectCMStatus", "../Images/tubesections_mid{0}.png")%>' CommandArgument="<%# Container.DataItemIndex %>" CommandName="gotoupdateCM"/>                                           
                        </asp:TableCell>
                        <asp:TableCell style='<%# CheckMid2Visible(Eval("CenterSections")) %>'>
                          <asp:ImageButton ID="btnUpdateSeamerCM2" runat="server" Visible='<%#Eval("CenterSections") = 4%>' ImageUrl='<%# Eval("SeamerSectCM2Status", "../Images/tubesections_mid2{0}.png")%>' CommandArgument="<%# Container.DataItemIndex %>" CommandName="gotoupdateCM2"/>                                           
                        </asp:TableCell>
                        <asp:TableCell>
                             <asp:ImageButton ID="btnUpdateSeamerCR" runat="server"  ImageUrl='<%# Eval("SeamerSectCRStatus", "../Images/tubesections_rear{0}.png")%>' CommandArgument="<%# Container.DataItemIndex %>" CommandName="gotoupdateCR" />                                         
                        </asp:TableCell>
                    </asp:TableRow>    
                    </asp:Table>
                    </ItemTemplate>
