...
Partial Class Tubes_Chines
    ...
    Protected Sub gvChines_RowCommand(sender As Object, e As GridViewCommandEventArgs) Handles gvChines.RowCommand
        If e.CommandName = "gotonotes" Then 'handles when the notes button is clicked
            Dim ID As String = e.CommandArgument 'get the row that is clicked
            Dim Selected As Integer = gvChines.Rows(ID).Cells(0).Text 'find the prod # in that row to use in the update command
            Dim workstation As String = "Chines" 'to pass in the workstation that makes the note.
        ...
        If e.CommandName = "gotoupdateP" Then
            ...
            Dim SelectedProdNo As Integer = gvChines.Rows(Key).Cells(0).Text 'find the prod # in that row to use in the update command
            Dim img As Image = CType(gvChines.Rows(Key).FindControl("btnUpdateChinesP"), Image)
            ...
            cmd.CommandText = "UPDATE BML_POPREPORTING_GREENLIGHTS SET ChinesStatusP = '2', Chines = '" & TodaysDate & "' where ProdNo =  '" & SelectedProdNo & "'"
            cmd2.CommandText = "Select Count (*) FROM BML_POPREPORTING_GREENLIGHTS where ChinesStatusS = 2 and ChinesStatusP = 2 and Convert(date,Chines) ='" & ThisDay & "'"
            ...
            'reverse done
            cmd4.CommandText = "UPDATE BML_POPREPORTING_GREENLIGHTS SET ChinesStatusP = '1', Chines = NULL where ProdNo =  '" & SelectedProdNo & "'"
            ...
            cmd6.CommandText = "Update BML_POPREPORTING_GREENLIGHTS Set RerunP = 1 where ProdNo = '" & SelectedProdNo & "'"
        ...
        If e.CommandName = "gotoupdateS" Then
            Dim Key As String = e.CommandArgument 'get the row that is clicked
            Dim SelectedProdNo As Integer = gvChines.Rows(Key).Cells(0).Text 'find the prod # in that row to use in the update command
            Dim img As Image = CType(gvChines.Rows(Key).FindControl("btnUpdateChinesS"), Image)
            Dim framevalue = img.ImageUrl
            framevalue = Mid(framevalue, 26, 1) 'get the value of FramesInstalledStatus from the imageurl. Get 1 character after 32.
            ...
            'to get the count of the prod #'s completed that day as it changes
            cmd.CommandText = "UPDATE BML_POPREPORTING_GREENLIGHTS SET ChinesStatusS = '2', Chines = '" & TodaysDate & "' where ProdNo =  '" & SelectedProdNo & "'"
            cmd2.CommandText = "Select Count (*) FROM BML_POPREPORTING_GREENLIGHTS where ChinesStatusS = 2 and ChinesStatusP = 2 and Convert(date,Chines) ='" & ThisDay & "'"
            'Determine if the next workstation already has a done date set.
            'cmd3.CommandText = "Select Count (*) FROM BML_POPREPORTING_GREENLIGHTS where FloorsInstalled is not NULL and ProdNo = '" & SelectedProdNo & "'"
            'reverse done
            cmd4.CommandText = "UPDATE BML_POPREPORTING_GREENLIGHTS SET ChinesStatusS = '1', Chines = NULL where ProdNo =  '" & SelectedProdNo & "'"
            ...
            'if it is, set rerun to in progress which will show as yellow.
            cmd6.CommandText = "Update BML_POPREPORTING_GREENLIGHTS Set RerunSB = 1 where ProdNo = '" & SelectedProdNo & "'"
        ...
        If e.CommandName = "gotoupdateCtr" Then
            Dim Key As String = e.CommandArgument 'get the row that is clicked
            Dim SelectedProdNo As Integer = gvChines.Rows(Key).Cells(0).Text 'find the prod # in that row to use in the update command
            Dim img As Image = CType(gvChines.Rows(Key).FindControl("btnUpdateChinesCtr"), Image)
            Dim framevalue = img.ImageUrl
            framevalue = Mid(framevalue, 26, 1) 'get the value of FramesInstalledStatus from the imageurl. Get 1 character after 32.
            ...
            'to get the count of the prod #'s completed that day as it changes
            cmd.CommandText = "UPDATE BML_POPREPORTING_GREENLIGHTS SET ChinesStatusCtr = '2', ChinesCtr = '" & TodaysDate & "' where ProdNo =  '" & SelectedProdNo & "'"
            cmd2.CommandText = "Select Count (*) FROM BML_POPREPORTING_GREENLIGHTS where ChinesStatusCtr = 2 and ChinesStatusP = 2 and ChinesStatusS = 2 and Convert(date,Chines) ='" & ThisDay & "'"
            'Determine if the next workstation already has a done date set.
            'cmd3.CommandText = "Select Count (*) FROM BML_POPREPORTING_GREENLIGHTS where FloorsInstalled is not NULL and ProdNo = '" & SelectedProdNo & "'"
            'reverse done
            cmd4.CommandText = "UPDATE BML_POPREPORTING_GREENLIGHTS SET ChinesStatusCtr = '1', ChinesCtr = NULL where ProdNo =  '" & SelectedProdNo & "'"
            'look to see if it is a rerun
            cmd5.CommandText = "Select RerunCtr from BML_POPREPORTING_GREENLIGHTS where ProdNo = '" & SelectedProdNo & "'"
            'if it is, set rerun to in progress which will show as yellow.
            cmd6.CommandText = "Update BML_POPREPORTING_GREENLIGHTS Set RerunCtr = 1 where ProdNo = '" & SelectedProdNo & "'"
    ...
    Protected Sub gvChines_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles gvChines.RowDataBound
