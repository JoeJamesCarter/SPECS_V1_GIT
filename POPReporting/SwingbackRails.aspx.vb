...
Partial Class SwingbackRails
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        cmd2.CommandText = "Select Count (*) FROM BML_POPREPORTING_GREENLIGHTS where SBRailsStatus = 2 and Convert(date,SBRails) ='" & ThisDay & "'"
        ...
        'Hide some stuff in the building toolbar that I don't want.

        lblios.Visible = False
        lblReadytoStart.Visible = False
        lblIOsReady.Visible = False
    ...
    Protected Sub gvAllFieldsF_RowCommand(sender As Object, e As GridViewCommandEventArgs) Handles gvAllFieldsF.RowCommand
        ...
        If e.CommandName = "UpdateSBRailStatus" Then
            ...
            Dim rbList As RadioButtonList = DirectCast(gvAllFieldsF.Rows(Key).Cells(4).FindControl("rbList"), RadioButtonList)
            ...
            cmd.CommandText = "UPDATE BML_POPREPORTING_GREENLIGHTS SET SBRailsStatus = '" & rbList.SelectedValue & "' , SBRails = '" & TodaysDate & "' where ProdNo =  '" & SelectedProdNo & "'"
            cmd2.CommandText = "Select Count (*) FROM BML_POPREPORTING_GREENLIGHTS where SBRailsStatus = 2 and Convert(date,SBRails) ='" & ThisDay & "'"
    ...
    Private Sub gvAllFieldsF_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles gvAllFieldsF.RowDataBound

        If e.Row.RowType = DataControlRowType.DataRow Then

            Dim s As SqlDataSource = CType(e.Row.FindControl("sdsPopReportingByProdNo"), SqlDataSource)
            Dim t As SqlDataSource = CType(e.Row.FindControl("sdsPopReportingRails"), SqlDataSource)
