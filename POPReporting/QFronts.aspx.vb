...
Partial Class QFronts
    ...
    Protected Sub gvAllFieldsF_RowCommand(sender As Object, e As GridViewCommandEventArgs) Handles gvAllFieldsG.RowCommand
        ...
        If e.CommandName = "UpdateQFrontStatus" Then
            ...
            Dim rbList As RadioButtonList = DirectCast(gvAllFieldsG.Rows(Key).Cells(4).FindControl("rblQFrontStatus"), RadioButtonList)
            ...
            cmd.CommandText = "UPDATE BML_POPREPORTING_GREENLIGHTS SET QFrontStatus = '" & rbList.SelectedValue & "' , QFront = '" & TodaysDate & "' where ProdNo =  '" & SelectedProdNo & "'"
            cmd2.CommandText = "Select Count (*) FROM BML_POPREPORTING_GREENLIGHTS where QFrontStatus = 2 and Convert(date,QFront) ='" & ThisDay & "'"
