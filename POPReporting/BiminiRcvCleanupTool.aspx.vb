...
Partial Class BiminiRcvCleanupTool
    ...
    Protected Sub gvBiminis_RowCommand(sender As Object, e As GridViewCommandEventArgs) Handles gvBiminis.RowCommand
        ...
        If e.CommandName = "UpdateBiminiRcvdStatus" Then
            ...
            'Change the status but don't set a date so you do not affect the daily receiving counts
            cmd.CommandType = CommandType.Text
            cmd.CommandText = "UPDATE BML_POPREPORTING_GREENLIGHTS SET BiminiRcvdStatus = '" & rbList.SelectedValue & "' where ProdNo =  '" & SelectedProdNo & "'"
