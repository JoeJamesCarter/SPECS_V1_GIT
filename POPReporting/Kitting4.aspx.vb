...
Partial Class Kitting4
    ...
    Protected Sub gvKitting_RowCommand(sender As Object, e As GridViewCommandEventArgs) Handles gvKitting.RowCommand
        If e.CommandName = "goto" Then 'handles when the notes button is clicked
            ...
            Dim workstation As String = "Kitting4" 'to pass in the workstation that makes the note.
        ...
        If e.CommandName = "UpdateKittingStatus" Then
            ...
            cmd.CommandText = "UPDATE BML_POPREPORTING_GREENLIGHTS SET Kitting4Status = '" & rbList.SelectedValue & "' , Kitting4 = '" & TodaysDate & "' where ProdNo =  '" & SelectedProdNo & "'"
            cmd2.CommandText = "Select Count (*) FROM BML_POPREPORTING_GREENLIGHTS where Kitting4Status = 2 and Convert(date,Kitting4) ='" & ThisDay & "'"
