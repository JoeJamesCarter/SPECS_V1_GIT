...
Partial Class OverviewTest
    ...
    Private Shared Sub AddSuperHeader(gridView As GridView)
        ...
        myNewRow.Cells.Add(MakeCell(centertubecountM, 1))
    ...
    Protected Sub gvOverview_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles gvOverview.RowDataBound
        ...
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            e.Row.Cells(7).ToolTip = "Boat/Customer/Due Date"
            e.Row.Cells(8).ToolTip = "Custom"
            e.Row.Cells(9).ToolTip = "Pilot"
            e.Row.Cells(10).ToolTip = "Frames"
            e.Row.Cells(11).ToolTip = "Floors"
            e.Row.Cells(12).ToolTip = "Rails"
            e.Row.Cells(13).ToolTip = "Furniture"
            e.Row.Cells(14).ToolTip = "Helm"
            e.Row.Cells(15).ToolTip = "Inspection"
            e.Row.Cells(16).ToolTip = "Final Inspection"
            e.Row.Cells(17).ToolTip = "Shrinkwrap"
            e.Row.Cells(18).ToolTip = "Rigging"
            e.Row.Cells(19).ToolTip = "Wavetamer"
            e.Row.Cells(20).ToolTip = "Sharkhide"
            e.Row.Cells(21).ToolTip = "Complete"
            e.Row.Cells(22).ToolTip = "Offline"
            e.Row.Cells(23).ToolTip = "Notes"
        End If
