<%@ Page Language="VB" AutoEventWireup="false" CodeFile="OverviewKitting.aspx.vb" Inherits="OverviewKitting" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Overview - Kitting</title>
    <style type="text/css">
        .newStyle1 {
            font-family: calibri;
            font-size: 14px;
                ...
                <Columns>
                    ...
                    <asp:ImageField DataImageUrlField="Kitting4Status" DataImageUrlFormatString="./Images/{0}.png" HeaderText="K4">
                     ...
                     <asp:TemplateField HeaderText="KS">
                        <ItemTemplate>
                            <asp:ImageButton ID="btnKitSouth" Enabled="false" runat="server" Visible=' <%# Eval("BuildLoc") = "S"%>' ImageUrl='<%# Eval("KittingSouthStatus", "./Images/{0}.png")%>' />
                        </ItemTemplate>
                    </asp:TemplateField>
