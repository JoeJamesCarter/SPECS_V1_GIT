<%@ Page Language="VB" AutoEventWireup="false" CodeFile="BiminiRcvCleanupTool.aspx.vb" Inherits="BiminiRcvCleanupTool" Debug="true" MaintainScrollPositionOnPostback="true"%>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>BIMINI RCV CLEANUP TOOL</title>
...
<body>   
  ...
  <div>
            <asp:Table ID="tblHeader" runat="server" CssClass="auto-style1" Width="800px" GridLines="None">
                <asp:TableRow>
                    <asp:TableCell>
                        <span class="newStyle7">BIMINI RCV CLEANUP TOOL</span><br />
            ...
            <asp:SqlDataSource ID="sdsPopReporting" runat="server" ConnectionString="<%$ ConnectionStrings:bml_dataConnectionString %>" SelectCommand="SELECT BML_POPREPORTING_GREENLIGHTS.ProdNo, BML_POPREPORTING_GREENLIGHTS.SONo,  BML_POPREPORTING_GREENLIGHTS.ItemNo, BML_POPREPORTING_GREENLIGHTS.CusName, BML_POPREPORTING_GREENLIGHTS.BaseVinylColor, BML_POPREPORTING_GREENLIGHTS.IsCustom, BML_POPREPORTING_GREENLIGHTS.IsPilot, BML_POPREPORTING_GREENLIGHTS.NotesGauge, BML_POPREPORTING_GREENLIGHTS.GaugeStatus, BML_POPREPORTING_GREENLIGHTS.BoatHasNotes, BML_POPREPORTING_GREENLIGHTS.BuildLoc, BML_POPREPORTING_GREENLIGHTS.CentertubeStatus, BML_POPREPORTING_GREENLIGHTS.CentertubeNeeded,BML_POPREPORTING_GREENLIGHTS.BiminiRcvdStatus,BML_POPREPORTING_GREENLIGHTS.Bimini, Rails_Tracking.Blackout, Load_Scheduling.DateLoaded, CASE When BML_POPREPORTING_GREENLIGHTS.CompleteStatus = '2' Then 'Complete' WHEN BML_POPREPORTING_GREENLIGHTS.SharkhideStatus = '1' Then 'Sharkhide' When BML_POPREPORTING_GREENLIGHTS.WavetamerStatus ='1' Then 'Wavetamer' When BML_POPREPORTING_GREENLIGHTS.RiggingStatus ='1' Then 'Rigging' When BML_POPREPORTING_GREENLIGHTS.ShrinkwrapStatus ='1' Then 'Shrinkwrap' When BML_POPREPORTING_GREENLIGHTS.CleaningStatus ='1' Then 'Inspection' When BML_POPREPORTING_GREENLIGHTS.FinalInspectionStatus ='1' Then 'Final' When BML_POPREPORTING_GREENLIGHTS.HelmInstalledStatus ='1' Then 'Helm' When BML_POPREPORTING_GREENLIGHTS.FurnitureInstalledStatus ='1' Then 'Furniture' When BML_POPREPORTING_GREENLIGHTS.RailsInstalledStatus ='1' Then 'Rails' When BML_POPREPORTING_GREENLIGHTS.FloorsInstalledStatus ='1' Then 'Floors' When BML_POPREPORTING_GREENLIGHTS.FramesInstalledStatus ='1' Then 'Frames' End as CurrentStatus FROM BML_POPREPORTING_GREENLIGHTS Left Join Rails_Tracking on BML_POPREPORTING_GREENLIGHTS.ProdNo = Rails_Tracking.ProdNo Left Join Load_Scheduling On BML_POPREPORTING_GREENLIGHTS.ProdNo = Load_Scheduling.ProdNo WHERE (BML_POPREPORTING_GREENLIGHTS.DueDate &lt;= @DueDate ) AND (BML_POPREPORTING_GREENLIGHTS.BiminiRcvdStatus &lt;= @BiminiRcvdStatus) AND (BML_POPREPORTING_GREENLIGHTS.ProdNo LIKE '%' + @Search + '%') AND (BML_POPREPORTING_GREENLIGHTS.ItemNo LIKE '%' + @SearchBoat + '%') AND BML_POPREPORTING_GREENLIGHTS.ItemNo Not LIKE '%T%' AND BML_POPREPORTING_GREENLIGHTS.ItemNo Not Like '%BA%'  AND BML_POPREPORTING_GREENLIGHTS.ItemNo Not Like '%RA%'  AND BML_POPREPORTING_GREENLIGHTS.ItemNo Not Like '%WA%' AND (BML_POPREPORTING_GREENLIGHTS.BUILDLOC LIKE  '%' + @BuildLocation + '%') AND (BML_POPREPORTING_GREENLIGHTS.ProdNo > 185346) AND ((Convert(date,BML_POPREPORTING_GREENLIGHTS.Bimini) > '02-17-18' ) OR (BML_POPREPORTING_GREENLIGHTS.Bimini is null)) ORDER BY BML_POPREPORTING_GREENLIGHTS.ProdNo">
                <SelectParameters>
