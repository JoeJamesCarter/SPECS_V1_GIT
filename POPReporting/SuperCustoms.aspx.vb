...
Partial Class SuperCustoms
    ...
    Protected Sub gvAllFieldsF_RowCommand(sender As Object, e As GridViewCommandEventArgs) Handles gvAllFieldsG.RowCommand
        ...
        If e.CommandName = "UpdateArchTowerNeeded" Then
            ...
            Dim rbList As RadioButtonList = DirectCast(gvAllFieldsG.Rows(Key).Cells(4).FindControl("rblArchTowerStatus"), RadioButtonList)
            ...
            cmd.CommandText = "UPDATE BML_POPREPORTING_GREENLIGHTS SET ArchTowerStatus = '" & rbList.SelectedValue & "' , ArchTower = '" & TodaysDate & "' where ProdNo =  '" & SelectedProdNo & "'"
            cmd2.CommandText = "Select Count (*) FROM BML_POPREPORTING_GREENLIGHTS where ArchTowerStatus = 2 and Convert(date,ArchTower) ='" & ThisDay & "'"
            ...
            cmd12.CommandText = "UPDATE BML_POPREPORTING_GREENLIGHTS SET ArchTowerNeeded = 0, ArchTowerStatus = 4 where ProdNo =  '" & SelectedProdNo & "'"
            ...
            If rbList.SelectedValue = 4 Then
