    ...
    <asp:table id="Table1" runat="server" cssclass="auto-style1" width="1208px" gridlines="None">
        <asp:TableRow runat="server">
            <asp:TableCell runat="server" HorizontalAlign="center">
                ...
                <span class="newStyle3">- Started&nbsp;&nbsp;</span>
            </asp:TableCell>
    ...
    <asp:button runat="server" text="Clear" id="btnClear" onclick="btnClear_Click" /></span>
        ...
        <asp:TableRow runat="server">
            <asp:TableCell HorizontalAlign="left">
                <asp:Label ID="lblReadytoStart" runat="server" CssClass="greensmall" Text="Label"></asp:Label>
                <span class="small">
                    <asp:Label ID="lblReady" runat="server" Text="- Ready To Go Online"></asp:Label></span><br />
                <asp:Label ID="lblios" runat="server" CssClass="greensmall" Text="Label"></asp:Label>
                <span class="small">
