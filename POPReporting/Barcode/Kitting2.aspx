<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Kitting2.aspx.vb" Inherits="Barcode_Kitting2" %>
...
<body>
    ...
    <div id="barcodescanner">
        <asp:Label ID="Label1" runat="server" Text="Kitting 2" Font-Size="40px"></asp:Label> <br />
