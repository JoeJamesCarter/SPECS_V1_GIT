<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Audit.aspx.vb" Inherits="Barcode_Tubes_Audit" %>
...
<body>
    ...
    <div id="barcodescanner">
        <asp:Label ID="Label3" runat="server" Text="Audit: "></asp:Label>
        <asp:Label ID="Label1" runat="server" Text="Audit" Font-Size="40px"></asp:Label> <br />
