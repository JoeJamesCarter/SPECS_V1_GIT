...
Partial Class Barcode_Tubes_Repair1
    ...
    Protected Function MarkComplete() As String
        ...
        If tubetype = "" Or tubetype = "RERUN" Then
            If section = "PF" Or section = "PM" Or section = "PM2" Or section = "PR" Then
                cmd.CommandText = "UPDATE Tubes SET Repair1PStatus = 2, Repair1P = @TodaysDate, Repair1PID = @station, Aircheck2PStatus = -1 where ProdNo =  @prodno"
            ElseIf section = "SF" Or section = "SM" Or section = "SM2" Or section = "SR" Then
                cmd.CommandText = "UPDATE Tubes SET Repair1SStatus = 2, Repair1S = @TodaysDate, Repair1SID = @station, Aircheck2SStatus = -1 where ProdNo =  @prodno"
            ElseIf section = "CF" Or section = "CM" Or section = "CM2" Or section = "CR" Then
                cmd.CommandText = "UPDATE Tubes SET Repair1CStatus = 2, Repair1C = @TodaysDate, Repair1CID = @station, Aircheck2CStatus = -1 where ProdNo =  @prodno"
            End If

        ElseIf tubetype = "WRTY" Then
            If section = "PF" Or section = "PM" Or section = "PM2" Or section = "PR" Then
                cmd.CommandText = "UPDATE CS_Tubes SET Repair1PStatus = 2, Repair1P = @TodaysDate, Repair1PID = @station, Aircheck2PStatus = -1 where TubeID =  @prodno"
            ElseIf section = "SF" Or section = "SM" Or section = "SM2" Or section = "SR" Then
                cmd.CommandText = "UPDATE CS_Tubes SET Repair1SStatus = 2, Repair1S = @TodaysDate, Repair1SID = @station, Aircheck2SStatus = -1 where TubeID =  @prodno"
            ElseIf section = "CF" Or section = "CM" Or section = "CM2" Or section = "CR" Then
                cmd.CommandText = "UPDATE CS_Tubes SET Repair1CStatus = 2, Repair1C = @TodaysDate, Repair1CID = @station, Aircheck2CStatus = -1 where TubeID =  @prodno"
            End If
        End If
