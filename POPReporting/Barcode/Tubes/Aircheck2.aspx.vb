...
Partial Class Barcode_Tubes_Aircheck2
    ...
    Protected Function MarkComplete() As String
        ...
        If tubetype = "" Or tubetype = "RERUN" Then
            If section = "PF" Or section = "PM" Or section = "PM2" Or section = "PR" Then
                cmd.CommandText = "UPDATE Tubes SET Aircheck2PStatus = 2, Aircheck2P = @TodaysDate, Aircheck2PID = @station, Repair2PStatus = -1 where ProdNo =  @prodno"
            ElseIf section = "SF" Or section = "SM" Or section = "SM2" Or section = "SR" Then
                cmd.CommandText = "UPDATE Tubes SET Aircheck2SStatus = 2, Aircheck2S = @TodaysDate, Aircheck2SID = @station, Repair2SStatus = -1 where ProdNo =  @prodno"
            ElseIf section = "CF" Or section = "CM" Or section = "CM2" Or section = "CR" Then
                cmd.CommandText = "UPDATE Tubes SET Aircheck2CStatus = 2, Aircheck2C = @TodaysDate, Aircheck2CID = @station, Repair2CStatus = -1 where ProdNo =  @prodno"
            End If

        ElseIf tubetype = "WRTY" Then
            If section = "PF" Or section = "PM" Or section = "PM2" Or section = "PR" Then
                cmd.CommandText = "UPDATE CS_Tubes SET Aircheck2PStatus = 2, Aircheck2P = @TodaysDate, Aircheck2PID = @station, Repair2PStatus = -1 where TubeID =  @prodno"
            ElseIf section = "SF" Or section = "SM" Or section = "SM2" Or section = "SR" Then
                cmd.CommandText = "UPDATE CS_Tubes SET Aircheck2SStatus = 2, Aircheck2S = @TodaysDate, Aircheck2SID = @station, Repair2SStatus = -1 where TubeID =  @prodno"
            ElseIf section = "CF" Or section = "CM" Or section = "CM2" Or section = "CR" Then
                cmd.CommandText = "UPDATE CS_Tubes SET Aircheck2CStatus = 2, Aircheck2C = @TodaysDate, Aircheck2CID = @station, Repair2CStatus = -1 where TubeID =  @prodno"
            End If
        End If
