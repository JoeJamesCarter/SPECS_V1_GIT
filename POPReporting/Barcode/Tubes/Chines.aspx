<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Chines.aspx.vb" Inherits="Barcode_Tubes_Chines" %>
...
<body>
    ...
    <div id="barcodescanner">
        <asp:Label ID="Label3" runat="server" Text="Chines: "></asp:Label>
        <asp:Label ID="Label1" runat="server" Text="Chines" Font-Size="40px"></asp:Label> <br />
