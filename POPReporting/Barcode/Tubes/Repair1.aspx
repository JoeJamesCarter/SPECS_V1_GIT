<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Repair1.aspx.vb" Inherits="Barcode_Tubes_Repair1" %>
...
<body>
    ...
    <div id="barcodescanner">
        <asp:Label ID="Label3" runat="server" Text="Repair 1: "></asp:Label>
        <asp:Label ID="Label1" runat="server" Text="Repair 1" Font-Size="40px"></asp:Label> <br />
