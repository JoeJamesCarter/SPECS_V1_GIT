<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FinalCenters.aspx.vb" Inherits="Barcode_Tubes_FinalCenters" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Final - Centers</title>
    <style>
        #barcodescanner {
        font-family:Calbri;
        font-size:70px;
...
<body>
    ...
    <div id="barcodescanner">
        <asp:Label ID="Label3" runat="server" Text="FINAL CENTERS: "></asp:Label>
        <asp:Label ID="Label1" runat="server" Text="FINAL CENTERS" Font-Size="40px"></asp:Label> <br />
