<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Repair2.aspx.vb" Inherits="Barcode_Tubes_Repair2" %>
...
<body>
    ...
    <div id="barcodescanner">
        <asp:Label ID="Label3" runat="server" Text="Repair 2: "></asp:Label>
        <asp:Label ID="Label1" runat="server" Text="Repair2" Font-Size="40px"></asp:Label> <br />
