<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FinalOuters.aspx.vb" Inherits="Barcode_Tubes_FinalOuters" %>
...
<body>
    ...
    <div id="barcodescanner">
        ...
        <asp:Label ID="Label1" runat="server" Text="FINAL" Font-Size="40px"></asp:Label> <br />
