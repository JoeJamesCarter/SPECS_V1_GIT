...
Partial Class Barcode_Tubes_RoundSeamer
    ...
    Protected Function MarkComplete() As String
        ...
        If tubetype = "" Or tubetype = "RERUN" Then
            ...
            If section = "PF" Or section = "PM" Or section = "PM2" Or section = "PR" Then
                cmd.CommandText = "UPDATE Tubes SET RoundSeamerPStatus = 2, RoundSeamerP = @TodaysDate, RoundSeamerPID = @station, BracketsPStatus = -1 where ProdNo =  @prodno"

            ElseIf section = "SF" Or section = "SM" Or section = "SM2" Or section = "SR" Then
                cmd.CommandText = "UPDATE Tubes SET RoundSeamerSStatus = 2, RoundSeamerS = @TodaysDate, RoundSeamerSID = @station, BracketsSStatus = -1 where ProdNo =  @prodno"

            ElseIf section = "CF" Or section = "CM" Or section = "CM2" Or section = "CR" Then
                cmd.CommandText = "UPDATE Tubes SET RoundSeamerCStatus = 2, RoundSeamerC = @TodaysDate, RoundSeamerCID = @station, BracketsCStatus = -1 where ProdNo =  @prodno"
            End If

        ElseIf tubetype = "WRTY" Then
            If section = "PF" Or section = "PM" Or section = "PM2" Or section = "PR" Then
                cmd.CommandText = "UPDATE CS_Tubes SET RoundSeamerPStatus = 2, RoundSeamerP = @TodaysDate, RoundSeamerPID = @station, BracketsPStatus = -1 where TubeID =  @prodno"

            ElseIf section = "SF" Or section = "SM" Or section = "SM2" Or section = "SR" Then
                cmd.CommandText = "UPDATE CS_Tubes SET RoundSeamerSStatus = 2, RoundSeamerS = @TodaysDate, RoundSeamerSID = @station, BracketsSStatus = -1 where TubeID =  @prodno"

            ElseIf section = "CF" Or section = "CM" Or section = "CM2" Or section = "CR" Then
                cmd.CommandText = "UPDATE CS_Tubes SET RoundSeamerCStatus = 2, RoundSeamerC = @TodaysDate, RoundSeamerCID = @station, BracketsCStatus = -1 where TubeID =  @prodno"
            End If
        End If
