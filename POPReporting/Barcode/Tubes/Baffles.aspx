<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Baffles.aspx.vb" Inherits="Barcode_Tubes_Baffles" %>
...
<body>
    ...
    <div id="barcodescanner">
        <asp:Label ID="Label3" runat="server" Text="BAFFLES: "></asp:Label>
        <asp:Label ID="Label1" runat="server" Text="BAFFLES" Font-Size="40px"></asp:Label> <br />
