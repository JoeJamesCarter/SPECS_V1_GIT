<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Seamer.aspx.vb" Inherits="Barcode_Tubes_Seamer" Debug="true"%>
...
<body>
    ...
    <div id="barcodescanner">
        <asp:Label ID="Label3" runat="server" Text="SEAMER: "></asp:Label>
        <asp:Label ID="Label1" runat="server" Text="SEAMER" Font-Size="40px"></asp:Label> <br />
