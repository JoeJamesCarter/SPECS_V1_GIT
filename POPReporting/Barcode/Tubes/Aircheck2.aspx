<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Aircheck2.aspx.vb" Inherits="Barcode_Tubes_Aircheck2" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Air Check 2</title>
<style>
        #barcodescanner {
        font-family:Calbri;
        font-size:70px;
...
<body>
    ...
    <div id="barcodescanner">
        <asp:Label ID="Label3" runat="server" Text="Air Check 2: "></asp:Label>
        <asp:Label ID="Label1" runat="server" Text="Air Check" Font-Size="40px"></asp:Label> <br />
