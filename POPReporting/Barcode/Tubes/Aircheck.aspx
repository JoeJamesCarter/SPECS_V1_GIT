<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Aircheck.aspx.vb" Inherits="Barcode_Tubes_Aircheck" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Air Check 1</title>
<style>
        #barcodescanner {
        font-family:Calbri;
        font-size:70px;
...
<body>
    ...
    <div id="barcodescanner">
        <asp:Label ID="Label3" runat="server" Text="Air Check 1: "></asp:Label>
