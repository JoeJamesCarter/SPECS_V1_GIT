<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Transom.aspx.vb" Inherits="Barcode_Tubes_Transom" %>
...
<body>
    ...
    <div id="barcodescanner">
        <asp:Label ID="Label3" runat="server" Text="Transom: "></asp:Label>
        <asp:Label ID="Label1" runat="server" Text="Transom" Font-Size="40px"></asp:Label> <br />
